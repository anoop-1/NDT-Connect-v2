...
export const CITIES_TIER_3_4: City[] = [
  ...
  {
    slug: "ras-tanura-sa",
    name: "Ras Tanura", state: "Saudi Arabia", country: "SA",
    region: "southwest", tier: 2,
    industries: ["Refining", "Crude Export Terminals", "NGL & Petrochemicals"],
    codeAuthorities: ["Saudi Aramco Engineering Standards (SAES)", "SAES-A-004 (NDT)", "API 510 / 570 / 653", "ASME Section V / VIII"],
    namedFacilities: [
      { name: "Saudi Aramco Ras Tanura Refinery", type: "Refinery" },
      { name: "Ras Tanura Sea Island crude terminal", type: "Crude export terminal" },
      { name: "Ju'aymah NGL Fractionation Plant", type: "Gas / NGL plant" },
    ],
    localPainQuote: "Ras Tanura runs the world's largest crude export terminal alongside a 550k bpd refinery — a single Aramco-approved Level II with a lapsed cert can stall splash-zone UT across miles of marine piping during a turnaround.",
    latitude: 26.6926, longitude: 50.1583,
  },
  {
    slug: "rabigh-sa",
    name: "Rabigh", state: "Saudi Arabia", country: "SA",
    region: "southwest", tier: 2,
    industries: ["Refining & Petrochemicals", "Industrial Development", "Power & Desalination"],
    codeAuthorities: ["Saudi Aramco Engineering Standards (SAES)", "SABIC Engineering Specifications", "API 510 / 570 / 653", "ASME Section V / VIII"],
    namedFacilities: [
      { name: "Petro Rabigh Refinery & Petrochemical Complex", type: "Refinery + petrochem" },
      { name: "King Abdullah Economic City (KAEC) industrial zone", type: "Industrial development" },
      { name: "Rabigh IPP", type: "Power plant" },
    ],
    localPainQuote: "Petro Rabigh stacks a refinery and a world-scale petrochemical complex on one Red Sea site — coastal CUI and high-temperature units mean a calibration slip on a single PAUT unit reshuffles a week of turnaround scopes.",
    latitude: 22.7986, longitude: 39.0349,
  },
  {
    slug: "jazan-sa",
    name: "Jazan", state: "Saudi Arabia", country: "SA",
    region: "southwest", tier: 3,
    industries: ["Refining", "Power & Gasification", "Port & Logistics"],
    codeAuthorities: ["Saudi Aramco Engineering Standards (SAES)", "SAES-A-004 (NDT)", "API 510 / 570 / 653", "ASME Section V / VIII"],
    namedFacilities: [
      { name: "Saudi Aramco Jazan Refinery", type: "Refinery" },
      { name: "Jazan IGCC power complex", type: "Power / gasification" },
      { name: "Jazan City (JCPDI) port", type: "Port" },
    ],
    localPainQuote: "Jazan pairs a 400k bpd refinery with one of the world's largest IGCC plants in a remote corner of the Kingdom — crews run self-contained cal labs because a single out-of-cal instrument 700km from Jeddah can idle a syngas train.",
    latitude: 16.8892, longitude: 42.5611,
  },
  {
    slug: "ruwais-ae",
    name: "Ruwais", state: "United Arab Emirates", country: "AE",
    region: "southwest", tier: 2,
    industries: ["Refining", "Petrochemicals", "Industrial City"],
    codeAuthorities: ["ADNOC HSE Codes of Practice", "ADNOC Engineering Standards (AGES)", "API 510 / 570 / 653", "ASME Section V / VIII"],
    namedFacilities: [
      { name: "ADNOC Ruwais Refinery", type: "Refinery" },
      { name: "Borouge polyolefins complex", type: "Petrochemical" },
      { name: "TA'ZIZ chemicals complex", type: "Chemicals" },
    ],
    localPainQuote: "ADNOC Ruwais is among the largest refinery sites on Earth — a single turnaround spans hundreds of vessels, so one PAUT unit drifting out of calibration cascades into a multi-day reschedule across the shutdown.",
    latitude: 24.1116, longitude: 52.7306,
  },
  {
    slug: "fujairah-ae",
    name: "Fujairah", state: "United Arab Emirates", country: "AE",
    region: "southwest", tier: 3,
    industries: ["Oil Storage & Bunkering", "Port & Marine", "Power & Desalination"],
    codeAuthorities: ["Fujairah Oil Industry Zone (FOIZ) standards", "API 650 / 653 (storage tanks)", "ASME Section VIII", "API 570"],
    namedFacilities: [
      { name: "Port of Fujairah", type: "Port" },
      { name: "Fujairah Oil Terminal (FOTCO / VTTI)", type: "Tank terminal" },
      { name: "Fujairah F2 power & desalination plant", type: "Power / desalination" },
    ],
    localPainQuote: "Fujairah is the Gulf's storage and bunkering capital — its tank farms make API 653 floor and shell inspection the daily scope, where one mis-set MFL floor scanner can quarantine a tank's return to service.",
    latitude: 25.1288, longitude: 56.3265,
  },
  {
    slug: "sohar-om",
    name: "Sohar", state: "Oman", country: "OM",
    region: "southwest", tier: 2,
    industries: ["Refining & Petrochemicals", "Metals", "Port & Freezone"],
    codeAuthorities: ["OQ engineering standards (Shell DEP-derived)", "API 510 / 570 / 653", "ASME Section V / VIII", "Oman Ministry of Energy standards"],
    namedFacilities: [
      { name: "OQ Sohar Refinery", type: "Refinery" },
      { name: "Sohar Aluminium", type: "Aluminium smelter" },
      { name: "Liwa Plastics Industrial Complex", type: "Petrochemical" },
      { name: "SOHAR Port and Freezone", type: "Port" },
    ],
    localPainQuote: "Sohar mixes a refinery, a naphtha cracker, an aluminium smelter and a steel mill in one port zone — a Level III current on OQ's Shell-DEP refinery specs is rarely current on the smelter's pot-line scope, so crews juggle parallel cert paths.",
    latitude: 24.3477, longitude: 56.7089,
  },
  {
    slug: "duqm-om",
    name: "Duqm", state: "Oman", country: "OM",
    region: "southwest", tier: 3,
    industries: ["Refining", "Port & Drydock", "Special Economic Zone"],
    codeAuthorities: ["OQ engineering standards", "API 510 / 570 / 653", "ASME Section V / VIII", "IACS classification (drydock)"],
    namedFacilities: [
      { name: "Duqm Refinery (OQ8)", type: "Refinery" },
      { name: "Port of Duqm & Drydock", type: "Port / shipyard" },
      { name: "SEZAD industrial zone", type: "Special economic zone" },
    ],
    localPainQuote: "Duqm is Oman's newest greenfield refinery and drydock 550km from Muscat — crews run camp rotations with self-contained calibration labs because the nearest backup instrument is a full day's drive away.",
    latitude: 19.65, longitude: 57.7,
  },
  {
    slug: "ras-laffan-qa",
    name: "Ras Laffan", state: "Qatar", country: "QA",
    region: "southwest", tier: 2,
    industries: ["LNG & Gas Processing", "GTL", "Refining & Petrochemicals"],
    codeAuthorities: ["QatarEnergy specifications (QE-SPC)", "API 510 / 570 / 653", "ASME Section V / VIII", "Qatar Ministry of Labour HSE"],
    namedFacilities: [
      { name: "QatarEnergy LNG (Ras Laffan)", type: "LNG complex" },
      { name: "Pearl GTL (Shell)", type: "Gas-to-liquids" },
      { name: "Laffan Refinery", type: "Refinery" },
      { name: "Ras Laffan Port", type: "Port" },
    ],
    localPainQuote: "Ras Laffan is the world's largest LNG site running cryogenic trains — a single exchanger UT scope missed during the North Field expansion window can stall a multi-billion-dollar commissioning sequence.",
    latitude: 25.9, longitude: 51.55,
  },
  {
    slug: "hazira-in",
    name: "Hazira", state: "India", country: "IN",
    region: "southwest", tier: 2,
    industries: ["Petrochemicals", "Steel", "Gas Processing & LNG"],
    codeAuthorities: ["PESO", "OISD-130 / OISD-128", "IBR (Indian Boiler Regulations)", "API 510 / 570 / 653", "ASME Section V / VIII"],
    namedFacilities: [
      { name: "Reliance Hazira Manufacturing Complex", type: "Petrochemical" },
      { name: "ArcelorMittal Nippon Steel Hazira", type: "Steel plant" },
      { name: "ONGC Hazira Gas Processing Plant", type: "Gas processing" },
      { name: "Shell Hazira LNG & Port", type: "LNG import terminal" },
      { name: "L&T Hazira", type: "Heavy fabrication" },
    ],
    localPainQuote: "Hazira packs a Reliance petrochem complex, an integrated steel plant, an LNG terminal and L&T's heavy-fab yard into one estuary — a single inspector has to juggle PESO, OISD, IBR and ASME code paths, and the wrong cert at the wrong gate kills the shift.",
    latitude: 21.11, longitude: 72.63,
  },
  {
    slug: "vadodara-in",
    name: "Vadodara", state: "India", country: "IN",
    region: "southwest", tier: 2,
    industries: ["Refining", "Fertilizers & Chemicals", "Petrochemicals & Engineering"],
    codeAuthorities: ["PESO", "OISD-130 / OISD-128", "IBR", "API 510 / 570 / 653", "ASME Section V / VIII"],
    namedFacilities: [
      { name: "IOCL Gujarat Refinery (Koyali)", type: "Refinery" },
      { name: "Gujarat State Fertilizers & Chemicals (GSFC)", type: "Fertilizer / chemicals" },
      { name: "Gujarat Alkalies & Chemicals (GACL)", type: "Chemicals" },
    ],
    localPainQuote: "IOCL's Koyali refinery is one of India's oldest large units, so Vadodara crews live on fixed-equipment re-rating and CUI scopes — a calibration lapse during a Gujarat-Refinery turnaround pushes a re-rate sign-off and the unit's restart with it.",
    latitude: 22.3072, longitude: 73.1812,
  },
  {
    slug: "mangalore-in",
    name: "Mangalore", state: "India", country: "IN",
    region: "southwest", tier: 2,
    industries: ["Refining", "Petrochemicals", "Fertilizers & Port"],
    codeAuthorities: ["PESO", "OISD-130 / OISD-128", "IBR", "API 510 / 570 / 653", "ASME Section V / VIII"],
    namedFacilities: [
      { name: "MRPL Refinery", type: "Refinery" },
      { name: "ONGC Mangalore Petrochemicals (OMPL)", type: "Petrochemical" },
      { name: "Mangalore Chemicals & Fertilizers", type: "Fertilizer" },
      { name: "New Mangalore Port", type: "Port" },
    ],
    localPainQuote: "Mangalore's MRPL refinery sits on a humid Arabian Sea coast where CUI is relentless — crews run continuous external corrosion and CUI campaigns, and one out-of-cal profile gauge can mean a missed wall-loss call on a critical line.",
    latitude: 12.9141, longitude: 74.856,
  },
  {
    slug: "paradip-in",
    name: "Paradip", state: "India", country: "IN",
    region: "southwest", tier: 2,
    industries: ["Refining", "Port & Logistics", "Fertilizers & Petrochemicals"],
    codeAuthorities: ["PESO", "OISD-130 / OISD-128", "IBR", "API 510 / 570 / 653", "ASME Section V / VIII"],
    namedFacilities: [
      { name: "IOCL Paradip Refinery", type: "Refinery" },
      { name: "Paradip Port", type: "Port" },
      { name: "Paradeep Phosphates", type: "Fertilizer" },
    ],
    localPainQuote: "IOCL Paradip is one of India's newest mega-refineries on a cyclone-exposed Bay of Bengal coast — narrow weather windows mean crews can't afford a single instrument out of calibration when a baseline thickness survey is on the clock.",
    latitude: 20.316, longitude: 86.609,
  },
  {
    slug: "haldia-in",
    name: "Haldia", state: "India", country: "IN",
    region: "southwest", tier: 2,
    industries: ["Refining", "Petrochemicals", "Port & Chemicals"],
    codeAuthorities: ["PESO", "OISD-130 / OISD-128", "IBR", "API 510 / 570 / 653", "ASME Section V / VIII"],
    namedFacilities: [
      { name: "IOCL Haldia Refinery", type: "Refinery" },
      { name: "Haldia Petrochemicals (HPL)", type: "Petrochemical" },
      { name: "Haldia Dock Complex", type: "Port" },
    ],
    localPainQuote: "Haldia welds a refinery to a naphtha cracker on the silty Hooghly — humid riverine corrosion plus furnace-tube creep scope mean a calibration miss on a cracker turnaround stalls the whole integrated complex's restart.",
    latitude: 22.0667, longitude: 88.0698,
  },
  {
    slug: "kakinada-in",
    name: "Kakinada", state: "India", country: "IN",
    region: "southwest", tier: 3,
    industries: ["Gas Processing", "Port & Fertilizers", "Petrochemicals"],
    codeAuthorities: ["PESO", "OISD-130 / OISD-128", "PNGRB", "API 510 / 570 / 653", "ASME Section V / VIII"],
    namedFacilities: [
      { name: "ONGC KG Basin Onshore Terminal", type: "Gas processing" },
      { name: "Kakinada Deep Water Port", type: "Port" },
      { name: "Coromandel International fertilizer", type: "Fertilizer" },
    ],
    localPainQuote: "Kakinada lands the Krishna-Godavari basin's deepwater gas onshore — terminal and pipeline integrity is the daily scope, and sour-gas service means a single mis-calibrated UT set can miss the wall loss that NACE rules were written to catch.",
    latitude: 16.9891, longitude: 82.2475,
  },
  {
    slug: "panipat-in",
    name: "Panipat", state: "India", country: "IN",
    region: "southwest", tier: 2,
    industries: ["Refining", "Petrochemicals", "Fertilizers"],
    codeAuthorities: ["PESO", "OISD-130 / OISD-128", "IBR", "API 510 / 570 / 653", "ASME Section V / VIII"],
    namedFacilities: [
      { name: "IOCL Panipat Refinery", type: "Refinery" },
      { name: "IOCL Panipat Petrochemical Complex", type: "Petrochemical" },
      { name: "National Fertilizers Panipat", type: "Fertilizer" },
    ],
    localPainQuote: "IOCL Panipat fuses a 15-MMTPA refinery with a naphtha cracker and a fertilizer complex north of Delhi — a calibration slip during a combined turnaround ripples across refinery, cracker and ammonia trains at once.",
    latitude: 29.3909, longitude: 76.9635,
  },
  {
    slug: "bathinda-in",
    name: "Bathinda", state: "India", country: "IN",
    region: "southwest", tier: 3,
    industries: ["Refining", "Petrochemicals", "Power"],
    codeAuthorities: ["PESO", "OISD-130 / OISD-128", "IBR", "API 510 / 570 / 653", "ASME Section V / VIII"],
    namedFacilities: [
      { name: "HMEL Guru Gobind Singh Refinery", type: "Refinery" },
      { name: "HMEL Petrochemical Complex", type: "Petrochemical" },
      { name: "Guru Nanak Dev Thermal Plant", type: "Power plant" },
    ],
    localPainQuote: "HMEL's Guru Gobind Singh Refinery anchors industrial Punjab far inland — crews stage their own calibration logistics because a single out-of-cal instrument 300km from Delhi can idle a full-conversion unit mid-turnaround.",
    latitude: 30.211, longitude: 74.9455,
  },
  {
    slug: "teesside-uk",
    name: "Teesside", state: "United Kingdom", country: "GB",
    region: "northeast", tier: 2,
    industries: ["Petrochemicals", "Fertilizers & Chemicals", "Hydrogen & CCS"],
    codeAuthorities: ["BS EN ISO 9712", "PD 5500", "PSSR 2000", "PED 2014/68/EU", "API 510 / 570 / 653"],
    namedFacilities: [
      { name: "Wilton International petrochemical complex", type: "Petrochemical" },
      { name: "CF Fertilisers Billingham", type: "Fertilizer / ammonia" },
      { name: "Teesport (PD Ports)", type: "Port" },
      { name: "Net Zero Teesside / bp H2Teesside", type: "Hydrogen / CCS" },
    ],
    localPainQuote: "Teesside is rebuilding around hydrogen and carbon capture on the old Wilton and Billingham sites — crews work shared NDT cells across multiple operators where a single lapsed PCN cert can lock an inspector out of three plants at once.",
    latitude: 54.576, longitude: -1.235,
  },
  {
    slug: "grangemouth-uk",
    name: "Grangemouth", state: "United Kingdom", country: "GB",
    region: "northeast", tier: 2,
    industries: ["Refining", "Petrochemicals", "Pipelines & Terminals"],
    codeAuthorities: ["BS EN ISO 9712", "PD 5500", "PSSR 2000", "PED 2014/68/EU", "DSEAR 2002"],
    namedFacilities: [
      { name: "Petroineos Grangemouth Refinery", type: "Refinery" },
      { name: "INEOS Grangemouth petrochemicals", type: "Petrochemical" },
      { name: "Forties Pipeline System terminal", type: "Crude terminal" },
    ],
    localPainQuote: "Grangemouth is Scotland's only refinery wired to the Forties crude terminus — one site's turnaround sets the whole region's inspection backlog, so a calibration miss there ripples across Scottish NDT capacity.",
    latitude: 56.011, longitude: -3.721,
  },
  {
    slug: "southampton-uk",
    name: "Southampton", state: "United Kingdom", country: "GB",
    region: "northeast", tier: 2,
    industries: ["Refining", "Petrochemicals", "Port & Marine"],
    codeAuthorities: ["BS EN ISO 9712", "PD 5500", "PSSR 2000", "PED 2014/68/EU", "API 510 / 570 / 653"],
    namedFacilities: [
      { name: "Esso Fawley Refinery", type: "Refinery" },
      { name: "ExxonMobil Fawley petrochemical plant", type: "Petrochemical" },
      { name: "Port of Southampton", type: "Port" },
    ],
    localPainQuote: "Esso Fawley is the UK's largest refinery on Southampton Water — its jetty and splash-zone piping plus full fixed-equipment scope mean a single out-of-cal UT set can stall a turnaround on the country's biggest single site.",
    latitude: 50.9097, longitude: -1.4044,
  },
  {
    slug: "ellesmere-port-uk",
    name: "Ellesmere Port", state: "United Kingdom", country: "GB",
    region: "northeast", tier: 2,
    industries: ["Refining", "Hydrogen & CCS", "Tank Storage & Chemicals"],
    codeAuthorities: ["BS EN ISO 9712", "PD 5500", "PSSR 2000", "PED 2014/68/EU", "API 510 / 570 / 653"],
    namedFacilities: [
      { name: "Essar Stanlow Refinery", type: "Refinery" },
      { name: "EET Hydrogen (HyNet North West)", type: "Hydrogen / CCS" },
      { name: "Stanlow Terminals", type: "Tank storage" },
    ],
    localPainQuote: "Essar Stanlow is the UK's second-largest refinery and the anchor of the HyNet hydrogen cluster — refinery turnarounds and new hydrogen-build inspection overlap, and a lapsed PCN cert locks an inspector out of both scopes at once.",
    latitude: 53.279, longitude: -2.897,
  },
  {
    slug: "immingham-uk",
    name: "Immingham", state: "United Kingdom", country: "GB",
    region: "northeast", tier: 2,
    industries: ["Refining", "Port & Logistics", "Power"],
    codeAuthorities: ["BS EN ISO 9712", "PD 5500", "PSSR 2000", "PED 2014/68/EU", "API 510 / 570 / 653"],
    namedFacilities: [
      { name: "Phillips 66 Humber Refinery", type: "Refinery" },
      { name: "Prax Lindsey Oil Refinery", type: "Refinery" },
      { name: "Port of Immingham (ABP)", type: "Port" },
      { name: "VPI Immingham CHP", type: "Power plant" },
    ],
    localPainQuote: "Immingham clusters two Humber refineries and the UK's largest port — the 'ndt services humberside' demand is real, and a single lapsed cert during overlapping refinery turnarounds idles a crew across both Phillips 66 and Lindsey scopes.",
    latitude: 53.613, longitude: -0.216,
  },
  {
    slug: "gladstone-au",
    name: "Gladstone", state: "Australia", country: "AU",
    region: "frontier-us", tier: 2,
    industries: ["LNG Export", "Alumina & Aluminium", "Power & Chemicals"],
    codeAuthorities: ["AS/NZS 3788 (pressure equipment)", "AS 1210 / AS 4458", "API 510 / 570 / 653", "ASME Section V / VIII", "WHS (Queensland)"],
    namedFacilities: [
      { name: "Curtis Island LNG (QCLNG / GLNG / APLNG)", type: "LNG export" },
      { name: "Queensland Alumina (QAL) & Rio Tinto Yarwun", type: "Alumina refinery" },
      { name: "Boyne Smelters", type: "Aluminium smelter" },
      { name: "Port of Gladstone", type: "Port" },
    ],
    localPainQuote: "Gladstone runs three CSG-LNG trains, two alumina refineries and a smelter off one harbour — a Level III current on cryogenic LNG exchanger codes is rarely current on caustic alumina-digester scope, so crews carry parallel qualifications.",
    latitude: -23.842, longitude: 151.255,
  },
  {
    slug: "karratha-au",
    name: "Karratha", state: "Australia", country: "AU",
    region: "frontier-us", tier: 2,
    industries: ["LNG & Gas", "Ammonia & Fertilizers", "Port & Resources"],
    codeAuthorities: ["AS/NZS 3788", "AS 1210 / AS 4458", "API 510 / 570 / 653", "ASME Section V / VIII", "WHS (Western Australia)"],
    namedFacilities: [
      { name: "Woodside Karratha Gas Plant (North West Shelf)", type: "LNG / gas plant" },
      { name: "Pluto LNG (Woodside)", type: "LNG export" },
      { name: "Yara Pilbara Ammonia (Burrup)", type: "Ammonia / fertilizer" },
      { name: "Dampier Port", type: "Port" },
    ],
    localPainQuote: "Karratha sits at the heart of the North West Shelf in the cyclone-prone Pilbara — FIFO crews run self-contained cal labs because at 1,500km from Perth, one out-of-calibration instrument can halt Australia's largest gas plant mid-shutdown.",
    latitude: -20.736, longitude: 116.846,
  },
  {
    slug: "kwinana-au",
    name: "Kwinana", state: "Australia", country: "AU",
    region: "frontier-us", tier: 2,
    industries: ["Energy & Renewable Fuels", "Lithium & Chemicals", "Alumina & Port"],
    codeAuthorities: ["AS/NZS 3788", "AS 1210 / AS 4458", "API 510 / 570 / 653", "ASME Section V / VIII", "WHS (Western Australia)"],
    namedFacilities: [
      { name: "BP Kwinana Energy Hub", type: "Renewable fuels / terminal" },
      { name: "Tianqi Lithium Kwinana", type: "Lithium hydroxide plant" },
      { name: "CSBP Kwinana", type: "Chemicals / fertilizer" },
      { name: "Kwinana Bulk Terminal", type: "Port" },
    ],
    localPainQuote: "Kwinana is reinventing itself from oil refining into lithium, renewable diesel and hydrogen — crews face exotic-alloy and corrosive-service scope where a single mis-set instrument can flag a battery-grade lithium line that an out-of-cal reading missed.",
    latitude: -32.239, longitude: 115.772,
  },
  {
    slug: "geelong-au",
    name: "Geelong", state: "Australia", country: "AU",
    region: "frontier-us", tier: 3,
    industries: ["Refining", "Energy Transition", "Port & Manufacturing"],
    codeAuthorities: ["AS/NZS 3788", "AS 1210 / AS 4458", "API 510 / 570 / 653", "ASME Section V / VIII", "WHS (Victoria)"],
    namedFacilities: [
      { name: "Viva Energy Geelong Refinery", type: "Refinery" },
      { name: "Viva Energy New Energies Hub", type: "LNG / hydrogen" },
      { name: "Port of Geelong", type: "Port" },
    ],
    localPainQuote: "Viva Energy Geelong is one of just two refineries left in Australia — that scarcity makes its turnaround the focal point of Victorian inspection demand, so a calibration miss there has nowhere to absorb the slack.",
    latitude: -38.1499, longitude: 144.3617,
  },
  {
    slug: "newcastle-au",
    name: "Newcastle", state: "Australia", country: "AU",
    region: "frontier-us", tier: 2,
    industries: ["Port & Bulk", "Aluminium", "Chemicals & Power"],
    codeAuthorities: ["AS/NZS 3788", "AS 1210 / AS 4458", "API 510 / 570 / 653", "ASME Section V / VIII", "WHS (New South Wales)"],
    namedFacilities: [
      { name: "Port of Newcastle", type: "Port" },
      { name: "Tomago Aluminium", type: "Aluminium smelter" },
      { name: "Orica Kooragang Island", type: "Ammonia / chemicals" },
    ],
    localPainQuote: "Newcastle pairs the world's largest coal port with Australia's biggest aluminium smelter and an Orica ammonia complex — structural, pot-line and high-pressure scopes all at once, so a Level III current on one is rarely current on the next.",
    latitude: -32.9283, longitude: 151.7817,
  },
  {
    slug: "darwin-au",
    name: "Darwin", state: "Australia", country: "AU",
    region: "frontier-us", tier: 3,
    industries: ["LNG", "Port & Energy", "Defence & Marine"],
    codeAuthorities: ["AS/NZS 3788", "AS 1210 / AS 4458", "API 510 / 570 / 653", "ASME Section V / VIII", "WHS (Northern Territory)"],
    namedFacilities: [
      { name: "INPEX Ichthys LNG (Bladin Point)", type: "LNG export" },
      { name: "Santos/ConocoPhillips Darwin LNG (Wickham Point)", type: "LNG export" },
      { name: "Port of Darwin", type: "Port" },
    ],
    localPainQuote: "Darwin's two LNG trains run in a tropical wet-dry climate at the remote Top End — crews compress shutdowns into the dry season, where a single out-of-cal cryogenic UT set can blow a once-a-year inspection window.",
