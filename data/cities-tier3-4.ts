...
export const CITIES_TIER_3_4: City[] = [
  ...
  },
  {
    ...
    region: "frontier-us", tier: 3,
    industries: ["Refining", "Pipelines", "Crude gathering (Bakken)"],
    codeAuthorities: ["API 510 / 570 / 653", "PHMSA"],
    namedFacilities: [
      { name: "Marathon Mandan Refinery", type: "Refinery" },
      { name: "Bakken crude pipeline gathering systems (regional)", type: "Pipeline corridor" },
    ],
  ...
  // ---------------- Tier 3 — Permian / SE New Mexico ----------------
  {
    ...
    industries: ["Permian shale upstream", "Midstream gas processing", "Nuclear fuel enrichment"],
  ...
  },
  {
    ...
    region: "permian-basin", tier: 3,
    industries: ["Upstream services", "Aerospace flight test", "Aircraft storage / MRO"],
    codeAuthorities: ["API 570", "FAA Part 145"],
    namedFacilities: [
      { name: "Roswell Air Center", type: "Aerospace MRO / aircraft storage" },
      { name: "Northwest Shelf oilfield service yards (regional)", type: "Oilfield services" },
    ],
  ...
  // ---------------- Tier 3 — Mid-Continent / Kansas ----------------
  {
    ...
    industries: ["Refining", "Pipelines", "Midstream / NGL"],
    codeAuthorities: ["API 510 / 570 / 653", "PHMSA"],
    namedFacilities: [
      { name: "HF Sinclair El Dorado Refinery", type: "Refinery" },
      { name: "Magellan Midstream El Dorado terminal (regional)", type: "Pipeline terminal" },
    ],
  ...
  },
  {
    ...
    region: "mid-continent", tier: 3,
    industries: ["Refining", "Specialty chemicals", "Pipelines"],
    codeAuthorities: ["API 510 / 570 / 653", "PHMSA"],
    namedFacilities: [
  ...
  // toledo-oh: defined in cities-tier2.ts — duplicate removed.
  {
    ...
    namedFacilities: [
      ...
      { name: "Marathon Pipe Line LLC (Findlay)", type: "Pipeline operator" },
    ],
  ...
  },
  {
    ...
    namedFacilities: [
      ...
      { name: "Port of Lorain (Black River)", type: "Great Lakes port" },
    ],
  ...
  },
  {
    ...
    namedFacilities: [
      { name: "Cleveland-Cliffs Mansfield Works", type: "Stainless / electrical steel" },
      { name: "Mansfield Lahm Air National Guard Base (179th Airlift Wing)", type: "ANG base / MRO" },
    ],
  ...
  },
  {
    ...
    region: "great-lakes", tier: 3,
    industries: ["Steel (tinplate)", "Manufacturing", "Energy / battery"],
    codeAuthorities: ["AWS D1.1", "ASME"],
    namedFacilities: [
      { name: "Cleveland-Cliffs Weirton (transitioning to electrical steel)", type: "Steel mill" },
      { name: "Form Energy Weirton plant", type: "Iron-air battery manufacturing" },
    ],
  ...
  },
  {
    ...
    region: "great-lakes", tier: 3,
    industries: ["Specialty chemicals", "Polymers", "Manufacturing"],
    codeAuthorities: ["API 570", "ASME Section VIII", "WVDEP"],
    namedFacilities: [
      { name: "Chemours Washington Works", type: "Fluoropolymers" },
      { name: "Constellium Ravenswood (regional)", type: "Aluminum rolling" },
    ],
  ...
  },
  {
    ...
    namedFacilities: [
      ...
      { name: "Raleigh County coal preparation plants (regional)", type: "Coal prep plant" },
    ],
  ...
  },
  {
    ...
    namedFacilities: [
      ...
      { name: "State Farm Corporate Headquarters", type: "Insurance HQ" },
    ],
  ...
  },
  {
    ...
    namedFacilities: [
      ...
      { name: "John Deere Davenport Works", type: "Construction equipment" },
    ],
  ...
  },
  {
    ...
    namedFacilities: [
      ...
      { name: "Integrated DNA Technologies (Coralville, regional)", type: "Biotech manufacturing" },
    ],
  ...
  },
  {
    ...
    region: "southeast", tier: 3,
    industries: ["Aerospace MRO (Robins AFB)", "Manufacturing", "Power generation"],
    codeAuthorities: ["FAA Part 145", "NAS 410", "MIL-STD"],
    namedFacilities: [
      { name: "Robins Air Force Base / WR-ALC", type: "USAF depot MRO" },
      { name: "Georgia Power Plant Scherer (regional)", type: "Coal power plant" },
    ],
  ...
  // memphis-tn: defined in cities-tier2.ts — duplicate removed.
  {
    ...
    namedFacilities: [
      ...
      { name: "Nissan Canton Assembly Plant (regional)", type: "Automotive manufacturing" },
    ],
  ...
  // pensacola-fl: defined in cities-tier2.ts — duplicate removed.
  {
    ...
    region: "southeast", tier: 3,
    industries: ["US Navy", "Shipyard repair", "Marine / port logistics"],
    codeAuthorities: ["NAVSEA T9074", "ABS", "ASME"],
    namedFacilities: [
      { name: "Naval Station Mayport", type: "USN surface fleet base" },
      { name: "BAE Systems Jacksonville Ship Repair (regional)", type: "Ship repair yard" },
    ],
  ...
  },
  {
    ...
    namedFacilities: [
      ...
      { name: "Florida Gas Transmission pipeline (regional)", type: "Gas pipeline" },
    ],
  ...
  // ---------------- Tier 3 — Pipeline ROW Kansas ----------------
  {
    ...
    namedFacilities: [
      ...
      { name: "Northern Natural Gas Hugoton compressor stations (regional)", type: "Gas compression" },
    ],
  ...
  },
  {
    ...
    region: "mid-continent", tier: 3,
    industries: ["Pipeline ROW", "Agriculture-adjacent industrial", "Wind energy O&M"],
    codeAuthorities: ["API 570", "PHMSA"],
    namedFacilities: [
      { name: "Mid-Continent crude and NGL pipeline ROW (regional)", type: "Pipeline corridor" },
      { name: "Meridian Way Wind Farm (regional)", type: "Wind farm" },
    ],
  ...
  // ---------------- Tier 3 — Texas defense ----------------
  {
    ...
    industries: ["Defense aerospace MRO", "ISR aircraft modifications", "Avionics / electronics manufacturing"],
    ...
    namedFacilities: [
      ...
      { name: "Majors Field (Greenville)", type: "Flight test airfield" },
    ],
