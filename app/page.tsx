...
import { CheckCircle, Search, Users, ShieldCheck, Activity } from 'lucide-react';
    ...
    const fetchHomepageImage = async () => {
      try {
        ...
        if (response.ok) {
          ...
          if (homepageImage) {
            setCurrentHomepageImage(`data:image/jpeg;base64,${homepageImage.data}`);
          } else {
            setCurrentHomepageImage(DEFAULT_HOMEPAGE_IMAGE);
          }
        } else {
          setCurrentHomepageImage(DEFAULT_HOMEPAGE_IMAGE);
        }
