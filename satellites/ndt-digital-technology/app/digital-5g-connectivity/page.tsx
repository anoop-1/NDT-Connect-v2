...
export const metadata: Metadata = {
  title: '5G for Remote NDT',
  description: 'Comprehensive guide to 5g for remote ndt for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-digital-technology.vercel.app/digital-5g-connectivity' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>5G for Remote NDT</span>
      </nav>

      <h1>5G for Remote NDT</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to 5g for remote ndt for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/digital-edge-computing' style={{ color: '#9333ea' }}>&larr; Edge Computing for NDT</a>
        <a href='/digital-wearable-tech' style={{ color: '#9333ea' }}>Wearable Tech for NDT &rarr;</a>
      </div>
    </div>
  );
}
