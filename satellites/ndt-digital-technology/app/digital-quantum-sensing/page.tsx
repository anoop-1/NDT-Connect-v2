...
export const metadata: Metadata = {
  title: 'Quantum Sensing NDT',
  description: 'Comprehensive guide to quantum sensing ndt for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-digital-technology.vercel.app/digital-quantum-sensing' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Quantum Sensing NDT</span>
      </nav>

      <h1>Quantum Sensing NDT</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to quantum sensing ndt for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/digital-printed-sensors' style={{ color: '#9333ea' }}>&larr; Printed NDT Sensors</a>
        <a href='/digital-sustainability' style={{ color: '#9333ea' }}>Sustainable NDT Technology &rarr;</a>
      </div>
    </div>
  );
}
