...
export const metadata: Metadata = {
  title: 'NDT Cybersecurity',
  description: 'Comprehensive guide to ndt cybersecurity for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-digital-technology.vercel.app/digital-cybersecurity' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>NDT Cybersecurity</span>
      </nav>

      <h1>NDT Cybersecurity</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to ndt cybersecurity for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/digital-nde-4-0' style={{ color: '#9333ea' }}>&larr; NDE 4.0 Framework</a>
        <a href='/digital-predictive-maintenance' style={{ color: '#9333ea' }}>Predictive Maintenance NDT &rarr;</a>
      </div>
    </div>
  );
}
