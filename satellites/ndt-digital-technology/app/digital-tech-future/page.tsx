...
export const metadata: Metadata = {
  title: 'Future of NDT Technology',
  description: 'Comprehensive guide to future of ndt technology for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-digital-technology.vercel.app/digital-tech-future' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Future of NDT Technology</span>
      </nav>

      <h1>Future of NDT Technology</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to future of ndt technology for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/digital-sustainability' style={{ color: '#9333ea' }}>&larr; Sustainable NDT Technology</a>
        <span></span>
      </div>
    </div>
  );
