  ...
  return (
    <div>
      ...
      <p style={{ fontSize: '1.1rem' }}>
        Exploring AI, machine learning, robotics, digital twins, and IoT applications transforming the NDT industry. Brought to you by <a href='https://ndt-connect.com' target='_blank' rel='noopener'>NDT Connect</a>, the leading marketplace for non-destructive testing services.
      </p>
      ...
      <div style={{ marginTop: '48px', padding: '24px', background: '#f8fafc', borderRadius: '8px' }}>
        ...
        <ul data-section='cornerstone-links'>
          ...
          <li><a href='https://ndt-connect.com/free-tools/ai-procedure-generator' target='_blank' rel='noopener'>Free AI NDT Procedure Generator</a></li>
        </ul>
        <ul>
        ...
        <a href='https://ndt-connect.com/register' target='_blank' rel='noopener' style={{ display: 'inline-block', background: '#9333ea', color: 'white', padding: '12px 24px', borderRadius: '6px', textDecoration: 'none', fontWeight: 600 }}>Join NDT Connect Free</a>
      </div>
    </div>
  );
}
