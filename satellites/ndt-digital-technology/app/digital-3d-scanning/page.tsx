...
export const metadata: Metadata = {
  title: '3D Scanning for NDT',
  description: 'Comprehensive guide to 3d scanning for ndt for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-digital-technology.vercel.app/digital-3d-scanning' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>3D Scanning for NDT</span>
      </nav>

      <h1>3D Scanning for NDT</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to 3d scanning for ndt for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/digital-blockchain' style={{ color: '#9333ea' }}>&larr; Blockchain for NDT Records</a>
        <a href='/digital-edge-computing' style={{ color: '#9333ea' }}>Edge Computing for NDT &rarr;</a>
      </div>
    </div>
  );
}
