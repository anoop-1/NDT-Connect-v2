...
export const metadata: Metadata = {
  title: 'Printed NDT Sensors',
  description: 'Comprehensive guide to printed ndt sensors for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-digital-technology.vercel.app/digital-printed-sensors' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Printed NDT Sensors</span>
      </nav>

      <h1>Printed NDT Sensors</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to printed ndt sensors for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/digital-signal-processing' style={{ color: '#9333ea' }}>&larr; Digital Signal Processing</a>
        <a href='/digital-quantum-sensing' style={{ color: '#9333ea' }}>Quantum Sensing NDT &rarr;</a>
      </div>
    </div>
  );
}
