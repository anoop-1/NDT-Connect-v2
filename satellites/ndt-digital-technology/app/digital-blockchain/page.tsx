...
export const metadata: Metadata = {
  title: 'Blockchain for NDT Records',
  description: 'Comprehensive guide to blockchain for ndt records for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-digital-technology.vercel.app/digital-blockchain' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Blockchain for NDT Records</span>
      </nav>

      <h1>Blockchain for NDT Records</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to blockchain for ndt records for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/digital-ai-radiograph' style={{ color: '#9333ea' }}>&larr; AI Radiograph Interpretation</a>
        <a href='/digital-3d-scanning' style={{ color: '#9333ea' }}>3D Scanning for NDT &rarr;</a>
      </div>
    </div>
  );
}
