...
export const metadata: Metadata = {
  title: {
    default: 'NDT Digital Technology - Digital Transformation in Non-Destructive Testing',
    template: '%s | NDT Digital Technology',
  },
  description: 'Exploring AI, machine learning, robotics, digital twins, and IoT applications transforming the NDT industry.',
  keywords: ['NDT', 'non-destructive testing', 'ndt digital technology', 'inspection'],
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang='en'>
      ...
      <body>
        <header style={{ borderBottom: '3px solid #9333ea', padding: '16px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <a href='/' style={{ fontWeight: 'bold', fontSize: '1.2rem', color: '#9333ea', textDecoration: 'none' }}>NDT Digital Technology</a>
          <nav style={{ display: 'flex', gap: '16px', fontSize: '0.9rem' }}>
            <a href='/' style={{ color: '#555', textDecoration: 'none' }}>Home</a>
            <a href='https://ndt-connect.com' target='_blank' rel='noopener' style={{ color: '#9333ea', textDecoration: 'none', fontWeight: 600 }}>NDT Connect</a>
          </nav>
        </header>
        ...
        <footer style={{ borderTop: '1px solid #e5e7eb', padding: '32px 24px', marginTop: '48px', textAlign: 'center', color: '#888', fontSize: '0.85rem' }}>
          <p>&copy; 2026 NDT Digital Technology. An educational resource by <a href='https://ndt-connect.com' target='_blank' rel='noopener' style={{ color: '#9333ea' }}>NDT Connect</a>.</p>
