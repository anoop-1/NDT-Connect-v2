...
export const metadata: Metadata = {
  title: 'IoT Sensors for NDT',
  description: 'Comprehensive guide to iot sensors for ndt for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-digital-technology.vercel.app/digital-iot-sensors' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>IoT Sensors for NDT</span>
      </nav>

      <h1>IoT Sensors for NDT</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to iot sensors for ndt for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/digital-digital-twins' style={{ color: '#9333ea' }}>&larr; Digital Twins for NDT</a>
        <a href='/digital-cloud-computing' style={{ color: '#9333ea' }}>Cloud Computing for NDT &rarr;</a>
      </div>
    </div>
  );
}
