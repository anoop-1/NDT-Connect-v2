...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive guide to continuing education for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-career-portal.vercel.app/career-continuing-education' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Continuing Education</span>
      </nav>

      <h1>Continuing Education</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to continuing education for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/career-power-gen-careers' style={{ color: '#ca8a04' }}>&larr; Power Generation NDT Careers</a>
        <a href='/career-professional-associations' style={{ color: '#ca8a04' }}>Professional Associations &rarr;</a>
      </div>
    </div>
  );
}
