  ...
  return (
    <div>
      ...
      <p style={{ fontSize: '1.1rem' }}>
        Career guidance resource for NDT professionals covering certifications, training programs, salary information, and career advancement. Brought to you by <a href='https://ndt-connect.com' target='_blank' rel='noopener'>NDT Connect</a>, the leading marketplace for non-destructive testing services.
      </p>
      ...
      <div style={{ marginTop: '48px', padding: '24px', background: '#f8fafc', borderRadius: '8px' }}>
        ...
        <ul data-section='cornerstone-links'>
          <li><a href='https://ndt-connect.com/certifications/asnt-certification' target='_blank' rel='noopener'>ASNT Certification Roadmap</a></li>
          <li><a href='https://ndt-connect.com/certifications/cwi-certification' target='_blank' rel='noopener'>AWS CWI Certification</a></li>
        </ul>
        <ul>
        ...
        <a href='https://ndt-connect.com/register' target='_blank' rel='noopener' style={{ display: 'inline-block', background: '#ca8a04', color: 'white', padding: '12px 24px', borderRadius: '6px', textDecoration: 'none', fontWeight: 600 }}>Join NDT Connect Free</a>
      </div>
    </div>
  );
}
