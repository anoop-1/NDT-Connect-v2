...
export const metadata: Metadata = {
  title: 'NDT Teaching Careers',
  description: 'Comprehensive guide to ndt teaching careers for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-career-portal.vercel.app/career-teaching-training' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>NDT Teaching Careers</span>
      </nav>

      <h1>NDT Teaching Careers</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to ndt teaching careers for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/career-research-development' style={{ color: '#ca8a04' }}>&larr; NDT Research Careers</a>
        <a href='/career-technical-sales' style={{ color: '#ca8a04' }}>Technical Sales Careers &rarr;</a>
      </div>
    </div>
  );
}
