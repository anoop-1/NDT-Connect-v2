...
export const metadata: Metadata = {
  title: 'Welding Inspector Career',
  description: 'Comprehensive guide to welding inspector career for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-career-portal.vercel.app/career-weld-inspector' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Welding Inspector Career</span>
      </nav>

      <h1>Welding Inspector Career</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to welding inspector career for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/career-rt-technician' style={{ color: '#ca8a04' }}>&larr; RT Technician Career</a>
        <a href='/career-ndt-manager' style={{ color: '#ca8a04' }}>NDT Manager Career Path &rarr;</a>
      </div>
    </div>
  );
}
