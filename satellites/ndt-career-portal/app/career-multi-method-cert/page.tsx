...
export const metadata: Metadata = {
  title: 'Multi-Method Certification',
  description: 'Comprehensive guide to multi-method certification for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-career-portal.vercel.app/career-multi-method-cert' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Multi-Method Certification</span>
      </nav>

      <h1>Multi-Method Certification</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to multi-method certification for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/career-digital-skills' style={{ color: '#ca8a04' }}>&larr; Digital Skills for NDT</a>
        <a href='/career-international-work' style={{ color: '#ca8a04' }}>International NDT Work &rarr;</a>
      </div>
    </div>
  );
}
