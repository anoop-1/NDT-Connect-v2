...
export const metadata: Metadata = {
  title: 'NDT Research Careers',
  description: 'Comprehensive guide to ndt research careers for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-career-portal.vercel.app/career-research-development' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>NDT Research Careers</span>
      </nav>

      <h1>NDT Research Careers</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to ndt research careers for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/career-quality-management' style={{ color: '#ca8a04' }}>&larr; Quality Management Roles</a>
        <a href='/career-teaching-training' style={{ color: '#ca8a04' }}>NDT Teaching Careers &rarr;</a>
      </div>
    </div>
  );
}
