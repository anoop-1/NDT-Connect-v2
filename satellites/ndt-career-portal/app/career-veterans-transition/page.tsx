...
export const metadata: Metadata = {
  title: 'Veterans in NDT',
  description: 'Comprehensive guide to veterans in ndt for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-career-portal.vercel.app/career-veterans-transition' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Veterans in NDT</span>
      </nav>

      <h1>Veterans in NDT</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to veterans in ndt for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/career-women-in-ndt' style={{ color: '#ca8a04' }}>&larr; Women in NDT</a>
        <a href='/career-job-market-trends' style={{ color: '#ca8a04' }}>Job Market Trends &rarr;</a>
      </div>
    </div>
  );
}
