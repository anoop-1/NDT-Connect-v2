...
export const metadata: Metadata = {
  title: 'NDT Resume Writing Tips',
  description: 'Comprehensive guide to ndt resume writing tips for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-career-portal.vercel.app/career-resume-writing' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>NDT Resume Writing Tips</span>
      </nav>

      <h1>NDT Resume Writing Tips</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to ndt resume writing tips for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/career-training-programs' style={{ color: '#ca8a04' }}>&larr; NDT Training Programs</a>
        <a href='/career-interview-prep' style={{ color: '#ca8a04' }}>NDT Interview Preparation &rarr;</a>
      </div>
    </div>
  );
}
