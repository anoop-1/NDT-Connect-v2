...
export const metadata: Metadata = {
  title: 'NDT Specializations',
  description: 'Comprehensive guide to ndt specializations for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-career-portal.vercel.app/career-specializations' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>NDT Specializations</span>
      </nav>

      <h1>NDT Specializations</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to ndt specializations for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/career-job-market-trends' style={{ color: '#ca8a04' }}>&larr; Job Market Trends</a>
        <a href='/career-api-inspector' style={{ color: '#ca8a04' }}>API Inspector Career &rarr;</a>
      </div>
    </div>
  );
}
