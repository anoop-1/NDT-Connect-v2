...
export const metadata: Metadata = {
  title: 'NDT Level III Career Path',
  description: 'Comprehensive guide to ndt level iii career path for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-career-portal.vercel.app/career-level-3-guide' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>NDT Level III Career Path</span>
      </nav>

      <h1>NDT Level III Career Path</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to ndt level iii career path for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/career-level-2-guide' style={{ color: '#ca8a04' }}>&larr; NDT Level II Career Path</a>
        <a href='/career-training-programs' style={{ color: '#ca8a04' }}>NDT Training Programs &rarr;</a>
      </div>
    </div>
  );
}
