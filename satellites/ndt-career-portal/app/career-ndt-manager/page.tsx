...
export const metadata: Metadata = {
  title: 'NDT Manager Career Path',
  description: 'Comprehensive guide to ndt manager career path for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-career-portal.vercel.app/career-ndt-manager' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>NDT Manager Career Path</span>
      </nav>

      <h1>NDT Manager Career Path</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to ndt manager career path for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/career-weld-inspector' style={{ color: '#ca8a04' }}>&larr; Welding Inspector Career</a>
        <a href='/career-rope-access' style={{ color: '#ca8a04' }}>Rope Access NDT Careers &rarr;</a>
      </div>
    </div>
  );
}
