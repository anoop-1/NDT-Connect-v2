...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive guide to job market trends for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-career-portal.vercel.app/career-job-market-trends' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Job Market Trends</span>
      </nav>

      <h1>Job Market Trends</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to job market trends for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/career-veterans-transition' style={{ color: '#ca8a04' }}>&larr; Veterans in NDT</a>
        <a href='/career-specializations' style={{ color: '#ca8a04' }}>NDT Specializations &rarr;</a>
      </div>
    </div>
  );
}
