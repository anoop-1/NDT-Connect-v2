...
export const metadata: Metadata = {
  title: 'Offshore CP Assessment',
  description: 'Comprehensive guide to offshore cp assessment for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://offshore-ndt-guide.vercel.app/offshore-cp-surveys' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Offshore CP Assessment</span>
      </nav>

      <h1>Offshore CP Assessment</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to offshore cp assessment for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/offshore-rov-inspection' style={{ color: '#0284c7' }}>&larr; ROV-Based NDT Inspection</a>
        <a href='/offshore-rbi' style={{ color: '#0284c7' }}>Offshore Risk-Based Inspection &rarr;</a>
      </div>
    </div>
  );
}
