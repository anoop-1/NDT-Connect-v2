...
export const metadata: Metadata = {
  title: 'Offshore MPI Testing',
  description: 'Comprehensive guide to offshore mpi testing for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://offshore-ndt-guide.vercel.app/offshore-mpi-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Offshore MPI Testing</span>
      </nav>

      <h1>Offshore MPI Testing</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to offshore mpi testing for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/offshore-drone-inspection' style={{ color: '#0284c7' }}>&larr; Drone Inspection Offshore</a>
        <a href='/offshore-acfm-inspection' style={{ color: '#0284c7' }}>ACFM Offshore Inspection &rarr;</a>
      </div>
    </div>
  );
}
