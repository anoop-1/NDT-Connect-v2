...
export const metadata: Metadata = {
  title: 'Drone Inspection Offshore',
  description: 'Comprehensive guide to drone inspection offshore for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://offshore-ndt-guide.vercel.app/offshore-drone-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Drone Inspection Offshore</span>
      </nav>

      <h1>Drone Inspection Offshore</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to drone inspection offshore for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/offshore-decommissioning' style={{ color: '#0284c7' }}>&larr; Decommissioning NDT</a>
        <a href='/offshore-mpi-inspection' style={{ color: '#0284c7' }}>Offshore MPI Testing &rarr;</a>
      </div>
    </div>
  );
}
