...
export const metadata: Metadata = {
  title: 'North Sea Standards',
  description: 'Comprehensive guide to north sea standards for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://offshore-ndt-guide.vercel.app/offshore-north-sea-standards' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>North Sea Standards</span>
      </nav>

      <h1>North Sea Standards</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to north sea standards for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/offshore-gom-requirements' style={{ color: '#0284c7' }}>&larr; Gulf of Mexico Requirements</a>
        <a href='/offshore-decommissioning' style={{ color: '#0284c7' }}>Decommissioning NDT &rarr;</a>
      </div>
    </div>
  );
}
