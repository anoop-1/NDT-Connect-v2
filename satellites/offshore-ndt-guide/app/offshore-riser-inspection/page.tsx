...
export const metadata: Metadata = {
  title: 'Riser Inspection Methods',
  description: 'Comprehensive guide to riser inspection methods for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://offshore-ndt-guide.vercel.app/offshore-riser-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Riser Inspection Methods</span>
      </nav>

      <h1>Riser Inspection Methods</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to riser inspection methods for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/offshore-pressure-systems' style={{ color: '#0284c7' }}>&larr; Offshore Pressure Systems</a>
        <a href='/offshore-flare-inspection' style={{ color: '#0284c7' }}>Flare Structure Inspection &rarr;</a>
      </div>
    </div>
  );
}
