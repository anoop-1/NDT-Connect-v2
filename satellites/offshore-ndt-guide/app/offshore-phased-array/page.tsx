...
export const metadata: Metadata = {
  title: 'Phased Array UT Offshore',
  description: 'Comprehensive guide to phased array ut offshore for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://offshore-ndt-guide.vercel.app/offshore-phased-array' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Phased Array UT Offshore</span>
      </nav>

      <h1>Phased Array UT Offshore</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to phased array ut offshore for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/offshore-eddy-current' style={{ color: '#0284c7' }}>&larr; Offshore Eddy Current</a>
        <a href='/offshore-tofd' style={{ color: '#0284c7' }}>TOFD for Offshore Welds &rarr;</a>
      </div>
    </div>
  );
}
