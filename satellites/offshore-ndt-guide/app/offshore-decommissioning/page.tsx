...
export const metadata: Metadata = {
  title: 'Decommissioning NDT',
  description: 'Comprehensive guide to decommissioning ndt for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://offshore-ndt-guide.vercel.app/offshore-decommissioning' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Decommissioning NDT</span>
      </nav>

      <h1>Decommissioning NDT</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to decommissioning ndt for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/offshore-north-sea-standards' style={{ color: '#0284c7' }}>&larr; North Sea Standards</a>
        <a href='/offshore-drone-inspection' style={{ color: '#0284c7' }}>Drone Inspection Offshore &rarr;</a>
      </div>
    </div>
  );
}
