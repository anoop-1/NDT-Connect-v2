...
export const metadata: Metadata = {
  title: 'Aerospace NDT Overview',
  description: 'Comprehensive guide to aerospace ndt overview for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://aerospace-ndt-center.vercel.app/aerospace-ndt-overview' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Aerospace NDT Overview</span>
      </nav>

      <h1>Aerospace NDT Overview</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to aerospace ndt overview for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <span></span>
        <a href='/aerospace-ut-inspection' style={{ color: '#4f46e5' }}>Aircraft Ultrasonic Inspection &rarr;</a>
      </div>
    </div>
  );
}
