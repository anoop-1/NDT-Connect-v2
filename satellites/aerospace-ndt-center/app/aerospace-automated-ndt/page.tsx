...
export const metadata: Metadata = {
  title: 'Automated NDT Aerospace',
  description: 'Comprehensive guide to automated ndt aerospace for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://aerospace-ndt-center.vercel.app/aerospace-automated-ndt' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Automated NDT Aerospace</span>
      </nav>

      <h1>Automated NDT Aerospace</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to automated ndt aerospace for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/aerospace-nadcap' style={{ color: '#4f46e5' }}>&larr; Nadcap Accreditation Guide</a>
        <a href='/aerospace-training-guide' style={{ color: '#4f46e5' }}>Aerospace NDT Training &rarr;</a>
      </div>
    </div>
  );
}
