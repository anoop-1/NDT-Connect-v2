...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive guide to landing gear inspection for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://aerospace-ndt-center.vercel.app/aerospace-landing-gear' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Landing Gear Inspection</span>
      </nav>

      <h1>Landing Gear Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to landing gear inspection for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/aerospace-bond-testing' style={{ color: '#4f46e5' }}>&larr; Adhesive Bond Testing</a>
        <a href='/aerospace-corrosion-inspection' style={{ color: '#4f46e5' }}>Aircraft Corrosion Inspection &rarr;</a>
      </div>
    </div>
  );
}
