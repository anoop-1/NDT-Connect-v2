...
export const metadata: Metadata = {
  title: 'Helicopter Component NDT',
  description: 'Comprehensive guide to helicopter component ndt for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://aerospace-ndt-center.vercel.app/aerospace-helicopter-ndt' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Helicopter Component NDT</span>
      </nav>

      <h1>Helicopter Component NDT</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to helicopter component ndt for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/aerospace-fatigue-inspection' style={{ color: '#4f46e5' }}>&larr; Aircraft Fatigue Inspection</a>
        <a href='/aerospace-welding-ndt' style={{ color: '#4f46e5' }}>Aerospace Weld Inspection &rarr;</a>
      </div>
    </div>
  );
}
