...
export const metadata: Metadata = {
  title: 'Eddy Current in Aerospace',
  description: 'Comprehensive guide to eddy current in aerospace for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://aerospace-ndt-center.vercel.app/aerospace-eddy-current' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Eddy Current in Aerospace</span>
      </nav>

      <h1>Eddy Current in Aerospace</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to eddy current in aerospace for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/aerospace-composite-ndt' style={{ color: '#4f46e5' }}>&larr; Composite Material NDT</a>
        <a href='/aerospace-rt-inspection' style={{ color: '#4f46e5' }}>Aircraft Radiographic Inspection &rarr;</a>
      </div>
    </div>
  );
}
