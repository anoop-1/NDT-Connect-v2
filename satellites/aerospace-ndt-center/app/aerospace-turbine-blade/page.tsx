...
export const metadata: Metadata = {
  title: 'Turbine Blade NDT',
  description: 'Comprehensive guide to turbine blade ndt for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://aerospace-ndt-center.vercel.app/aerospace-turbine-blade' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Turbine Blade NDT</span>
      </nav>

      <h1>Turbine Blade NDT</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to turbine blade ndt for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/aerospace-window-inspection' style={{ color: '#4f46e5' }}>&larr; Aircraft Window Inspection</a>
        <a href='/aerospace-supplier-ndt' style={{ color: '#4f46e5' }}>Supplier NDT Requirements &rarr;</a>
      </div>
    </div>
  );
}
