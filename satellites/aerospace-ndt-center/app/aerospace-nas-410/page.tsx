...
export const metadata: Metadata = {
  title: 'NAS 410 Qualification Guide',
  description: 'Comprehensive guide to nas 410 qualification guide for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://aerospace-ndt-center.vercel.app/aerospace-nas-410' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>NAS 410 Qualification Guide</span>
      </nav>

      <h1>NAS 410 Qualification Guide</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to nas 410 qualification guide for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/aerospace-codes-standards' style={{ color: '#4f46e5' }}>&larr; Aerospace NDT Standards</a>
        <a href='/aerospace-fatigue-inspection' style={{ color: '#4f46e5' }}>Aircraft Fatigue Inspection &rarr;</a>
      </div>
    </div>
  );
}
