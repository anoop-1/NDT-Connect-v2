...
export const metadata: Metadata = {
  title: 'Aircraft Window Inspection',
  description: 'Comprehensive guide to aircraft window inspection for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://aerospace-ndt-center.vercel.app/aerospace-window-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Aircraft Window Inspection</span>
      </nav>

      <h1>Aircraft Window Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to aircraft window inspection for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/aerospace-digital-ndt' style={{ color: '#4f46e5' }}>&larr; Digital NDT Aerospace</a>
        <a href='/aerospace-turbine-blade' style={{ color: '#4f46e5' }}>Turbine Blade NDT &rarr;</a>
      </div>
    </div>
  );
}
