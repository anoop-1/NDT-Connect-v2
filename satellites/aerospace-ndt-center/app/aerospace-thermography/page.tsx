...
export const metadata: Metadata = {
  title: 'Thermography in Aerospace',
  description: 'Comprehensive guide to thermography in aerospace for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://aerospace-ndt-center.vercel.app/aerospace-thermography' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Thermography in Aerospace</span>
      </nav>

      <h1>Thermography in Aerospace</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to thermography in aerospace for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/aerospace-mt-inspection' style={{ color: '#4f46e5' }}>&larr; Aerospace Magnetic Testing</a>
        <a href='/aerospace-shearography' style={{ color: '#4f46e5' }}>Shearography Inspection &rarr;</a>
      </div>
    </div>
  );
}
