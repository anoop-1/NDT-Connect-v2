...
export const metadata: Metadata = {
  title: 'SSPC Inspector Certification',
  description: 'Comprehensive guide to sspc inspector certification for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://industrial-coating-inspection.vercel.app/coating-sspc-certification' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>SSPC Inspector Certification</span>
      </nav>

      <h1>SSPC Inspector Certification</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to sspc inspector certification for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/coating-nace-inspector' style={{ color: '#16a34a' }}>&larr; NACE Inspector Certification</a>
        <a href='/coating-specifications' style={{ color: '#16a34a' }}>Coating Specifications &rarr;</a>
      </div>
    </div>
  );
}
