...
export const metadata: Metadata = {
  title: 'Fireproofing Inspection',
  description: 'Comprehensive guide to fireproofing inspection for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://industrial-coating-inspection.vercel.app/coating-fireproofing' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Fireproofing Inspection</span>
      </nav>

      <h1>Fireproofing Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to fireproofing inspection for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <h2>Overview</h2>
      <p>Comprehensive guide to fireproofing inspection for NDT professionals in industrial inspection and asset integrity management. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndtconnect.com/services/ultrasonic-testing' target='_blank' rel='noopener'>Ultrasonic Testing Services</a>. Learn more about <a href='https://ndtconnect.com/blog/ndt-career-guide-2026' target='_blank' rel='noopener'>NDT Career Guide</a>. Learn more about <a href='https://ndtconnect.com/services/magnetic-particle-testing' target='_blank' rel='noopener'>Magnetic Particle Testing</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding fireproofing inspection is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndtconnect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndtconnect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndtconnect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/coating-tank-coating' style={{ color: '#16a34a' }}>&larr; Tank Coating Inspection</a>
        <a href='/coating-thermal-spray' style={{ color: '#16a34a' }}>Thermal Spray Inspection &rarr;</a>
      </div>
    </div>
  );
}
