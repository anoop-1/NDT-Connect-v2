...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive guide to surface preparation standards for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://industrial-coating-inspection.vercel.app/coating-surface-prep-standards' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Surface Preparation Standards</span>
      </nav>

      <h1>Surface Preparation Standards</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to surface preparation standards for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/coating-inspection-basics' style={{ color: '#16a34a' }}>&larr; Coating Inspection Fundamentals</a>
        <a href='/coating-abrasive-blast' style={{ color: '#16a34a' }}>Abrasive Blast Inspection &rarr;</a>
      </div>
    </div>
  );
}
