...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive guide to laboratory testing for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://industrial-coating-inspection.vercel.app/coating-lab-testing' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Laboratory Testing</span>
      </nav>

      <h1>Laboratory Testing</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to laboratory testing for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/coating-defect-atlas' style={{ color: '#16a34a' }}>&larr; Coating Defect Atlas</a>
        <a href='/coating-oil-gas-coatings' style={{ color: '#16a34a' }}>Oil and Gas Coatings &rarr;</a>
      </div>
    </div>
  );
}
