...
export const metadata: Metadata = {
  title: {
    default: 'Industrial Coating Inspection - Professional Coating and Corrosion Protection Inspection',
    template: '%s | Industrial Coating Inspection',
  },
  ...
  keywords: ['NDT', 'non-destructive testing', 'industrial coating inspection', 'inspection'],
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang='en'>
      ...
      <body>
        <header style={{ borderBottom: '3px solid #16a34a', padding: '16px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <a href='/' style={{ fontWeight: 'bold', fontSize: '1.2rem', color: '#16a34a', textDecoration: 'none' }}>Industrial Coating Inspection</a>
          <nav style={{ display: 'flex', gap: '16px', fontSize: '0.9rem' }}>
            <a href='/' style={{ color: '#555', textDecoration: 'none' }}>Home</a>
            <a href='https://ndt-connect.com' target='_blank' rel='noopener' style={{ color: '#16a34a', textDecoration: 'none', fontWeight: 600 }}>NDT Connect</a>
          </nav>
        </header>
        ...
        <footer style={{ borderTop: '1px solid #e5e7eb', padding: '32px 24px', marginTop: '48px', textAlign: 'center', color: '#888', fontSize: '0.85rem' }}>
          <p>&copy; 2026 Industrial Coating Inspection. An educational resource by <a href='https://ndt-connect.com' target='_blank' rel='noopener' style={{ color: '#16a34a' }}>NDT Connect</a>.</p>
