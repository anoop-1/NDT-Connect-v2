...
export const metadata: Metadata = {
  title: 'Overcoating Inspection',
  description: 'Comprehensive guide to overcoating inspection for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://industrial-coating-inspection.vercel.app/coating-overcoating' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Overcoating Inspection</span>
      </nav>

      <h1>Overcoating Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to overcoating inspection for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/coating-repair-inspection' style={{ color: '#16a34a' }}>&larr; Coating Repair Inspection</a>
        <a href='/coating-qa-qc-programs' style={{ color: '#16a34a' }}>Coating QA/QC Programs &rarr;</a>
      </div>
    </div>
  );
}
