...
export const metadata: Metadata = {
  title: 'Coating Inspection Fundamentals',
  description: 'Comprehensive guide to coating inspection fundamentals for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://industrial-coating-inspection.vercel.app/coating-inspection-basics' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Coating Inspection Fundamentals</span>
      </nav>

      <h1>Coating Inspection Fundamentals</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to coating inspection fundamentals for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <span></span>
        <a href='/coating-surface-prep-standards' style={{ color: '#16a34a' }}>Surface Preparation Standards &rarr;</a>
      </div>
    </div>
  );
}
