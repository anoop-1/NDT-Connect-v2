...
export const metadata: Metadata = {
  title: 'RT for Pressure Vessel Welds',
  description: 'Radiographic examination requirements for pressure vessel welds per ASME Section VIII.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-for-pressure-vessels' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT for Pressure Vessel Welds</span>
      </nav>

      <h1>RT for Pressure Vessel Welds</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Radiographic examination requirements for pressure vessel welds per ASME Section VIII.</p>
      ...
      <h2>Overview</h2>
      <p>Radiographic examination requirements for pressure vessel welds per ASME Section VIII. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/case-studies' target='_blank' rel='noopener'>NDT Case Studies</a>. Learn more about <a href='https://ndt-connect.com/industries/mining' target='_blank' rel='noopener'>Mining NDT</a>. Learn more about <a href='https://ndt-connect.com/industries/oil-and-gas' target='_blank' rel='noopener'>Oil & Gas NDT</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt for pressure vessel welds is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-for-castings' style={{ color: '#dc2626' }}>&larr; RT Inspection of Castings</a>
        <a href='/rt-film-processing' style={{ color: '#dc2626' }}>RT Film Processing and Handling &rarr;</a>
      </div>
    </div>
  );
}
