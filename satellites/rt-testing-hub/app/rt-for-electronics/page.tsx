...
export const metadata: Metadata = {
  title: 'RT for Electronics Inspection',
  description: 'Micro-focus and nano-focus radiography for electronics, solder joint, and PCB inspection.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-for-electronics' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT for Electronics Inspection</span>
      </nav>

      <h1>RT for Electronics Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Micro-focus and nano-focus radiography for electronics, solder joint, and PCB inspection.</p>
      ...
      <h2>Overview</h2>
      <p>Micro-focus and nano-focus radiography for electronics, solder joint, and PCB inspection. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/tools/inspection-cost-estimator' target='_blank' rel='noopener'>NDT Cost Estimator</a>. Learn more about <a href='https://ndt-connect.com/industries/power-generation' target='_blank' rel='noopener'>Power Generation NDT</a>. Learn more about <a href='https://ndt-connect.com/services/tofd-testing' target='_blank' rel='noopener'>TOFD Testing Services</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt for electronics inspection is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-for-aerospace' style={{ color: '#dc2626' }}>&larr; RT in Aerospace Inspection</a>
        <a href='/rt-dose-calculation' style={{ color: '#dc2626' }}>RT Dose Calculation Methods &rarr;</a>
      </div>
    </div>
  );
}
