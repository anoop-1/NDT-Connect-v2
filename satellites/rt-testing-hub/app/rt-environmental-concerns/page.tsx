...
export const metadata: Metadata = {
  title: 'RT Environmental Considerations',
  description: 'Environmental regulations, waste disposal, and sustainability in radiographic testing.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-environmental-concerns' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT Environmental Considerations</span>
      </nav>

      <h1>RT Environmental Considerations</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Environmental regulations, waste disposal, and sustainability in radiographic testing.</p>
      ...
      <h2>Overview</h2>
      <p>Environmental regulations, waste disposal, and sustainability in radiographic testing. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/certifications/iso-9712' target='_blank' rel='noopener'>ISO 9712 Certification</a>. Learn more about <a href='https://ndt-connect.com/industries/marine-and-offshore' target='_blank' rel='noopener'>Marine & Offshore NDT</a>. Learn more about <a href='https://ndt-connect.com/services/eddy-current-testing' target='_blank' rel='noopener'>Eddy Current Testing</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt environmental considerations is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-quality-assurance' style={{ color: '#dc2626' }}>&larr; RT Quality Assurance Programs</a>
        <a href='/rt-future-technology' style={{ color: '#dc2626' }}>Future of Radiographic Testing &rarr;</a>
      </div>
    </div>
  );
}
