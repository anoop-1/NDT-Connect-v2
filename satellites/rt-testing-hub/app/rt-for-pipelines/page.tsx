...
export const metadata: Metadata = {
  title: 'RT Pipeline Weld Inspection',
  description: 'Radiographic testing procedures for pipeline girth weld inspection per API 1104 and ASME B31.3.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-for-pipelines' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT Pipeline Weld Inspection</span>
      </nav>

      <h1>RT Pipeline Weld Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Radiographic testing procedures for pipeline girth weld inspection per API 1104 and ASME B31.3.</p>
      ...
      <h2>Overview</h2>
      <p>Radiographic testing procedures for pipeline girth weld inspection per API 1104 and ASME B31.3. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/find-providers' target='_blank' rel='noopener'>Find NDT Providers</a>. Learn more about <a href='https://ndt-connect.com/faq' target='_blank' rel='noopener'>NDT FAQ</a>. Learn more about <a href='https://ndt-connect.com/blog/corrosion-under-insulation-guide' target='_blank' rel='noopener'>CUI Guide</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt pipeline weld inspection is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-image-quality' style={{ color: '#dc2626' }}>&larr; RT Image Quality Assessment</a>
        <a href='/rt-for-castings' style={{ color: '#dc2626' }}>RT Inspection of Castings &rarr;</a>
      </div>
    </div>
  );
}
