...
export const metadata: Metadata = {
  title: 'Computed Radiography Explained',
  description: 'Understanding computed radiography systems, imaging plates, scanning technology, and industrial applications.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-computed-radiography' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Computed Radiography Explained</span>
      </nav>

      <h1>Computed Radiography Explained</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Understanding computed radiography systems, imaging plates, scanning technology, and industrial applications.</p>
      ...
      <h2>Overview</h2>
      <p>Understanding computed radiography systems, imaging plates, scanning technology, and industrial applications. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog/ut-vs-rt-comparison' target='_blank' rel='noopener'>UT vs RT Comparison</a>. Learn more about <a href='https://ndt-connect.com/blog/ndt-career-guide-2026' target='_blank' rel='noopener'>NDT Career Guide</a>. Learn more about <a href='https://ndt-connect.com/blog/rbi-corrosion-management' target='_blank' rel='noopener'>RBI Corrosion Management</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding computed radiography explained is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-digital-radiography' style={{ color: '#dc2626' }}>&larr; Digital Radiography Guide</a>
        <a href='/rt-safety-procedures' style={{ color: '#dc2626' }}>RT Radiation Safety Procedures &rarr;</a>
      </div>
    </div>
  );
}
