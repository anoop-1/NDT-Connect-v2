...
export const metadata: Metadata = {
  title: 'RT for Corrosion Detection',
  description: 'Using radiographic testing for corrosion detection under insulation and in inaccessible areas.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-for-corrosion' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT for Corrosion Detection</span>
      </nav>

      <h1>RT for Corrosion Detection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Using radiographic testing for corrosion detection under insulation and in inaccessible areas.</p>
      ...
      <h2>Overview</h2>
      <p>Using radiographic testing for corrosion detection under insulation and in inaccessible areas. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/services/ultrasonic-testing' target='_blank' rel='noopener'>Ultrasonic Testing Services</a>. Learn more about <a href='https://ndt-connect.com/blog/ultimate-guide-ultrasonic-testing' target='_blank' rel='noopener'>Ultrasonic Testing Guide</a>. Learn more about <a href='https://ndt-connect.com/faq' target='_blank' rel='noopener'>NDT FAQ</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt for corrosion detection is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-defect-classification' style={{ color: '#dc2626' }}>&larr; RT Defect Classification Guide</a>
        <a href='/rt-digital-vs-film' style={{ color: '#dc2626' }}>Digital RT vs Film RT &rarr;</a>
      </div>
    </div>
  );
}
