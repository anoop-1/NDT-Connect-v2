...
export default function Page() {
  return (
    <div>
      ...
      <h2>Overview</h2>
      <p>Emerging technologies in RT including AI interpretation, portable CT, and robotic systems. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndtconnect.com/contact' target='_blank' rel='noopener'>Contact NDT Connect</a>. Learn more about <a href='https://ndtconnect.com/services/tofd-testing' target='_blank' rel='noopener'>TOFD Testing Services</a>. Learn more about <a href='https://ndtconnect.com/services/guided-wave-testing' target='_blank' rel='noopener'>Guided Wave Testing</a>.</p>
