...
export const metadata: Metadata = {
  title: 'Future of Radiographic Testing',
  description: 'Emerging technologies in RT including AI interpretation, portable CT, and robotic systems.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-future-technology' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Future of Radiographic Testing</span>
      </nav>

      <h1>Future of Radiographic Testing</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Emerging technologies in RT including AI interpretation, portable CT, and robotic systems.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-environmental-concerns' style={{ color: '#dc2626' }}>&larr; RT Environmental Considerations</a>
        <a href='/rt-neutron-radiography' style={{ color: '#dc2626' }}>Neutron Radiography Applications &rarr;</a>
      </div>
    </div>
  );
}
