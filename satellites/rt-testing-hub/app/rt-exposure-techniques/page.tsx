...
export const metadata: Metadata = {
  title: 'RT Exposure Techniques',
  description: 'Calculating exposure parameters for radiographic testing including time, distance, and source strength.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-exposure-techniques' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT Exposure Techniques</span>
      </nav>

      <h1>RT Exposure Techniques</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Calculating exposure parameters for radiographic testing including time, distance, and source strength.</p>
      ...
      <h2>Overview</h2>
      <p>Calculating exposure parameters for radiographic testing including time, distance, and source strength. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/services/visual-testing' target='_blank' rel='noopener'>Visual Testing Services</a>. Learn more about <a href='https://ndt-connect.com/contact' target='_blank' rel='noopener'>Contact NDT Connect</a>. Learn more about <a href='https://ndt-connect.com/tools/inspection-cost-estimator' target='_blank' rel='noopener'>NDT Cost Estimator</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt exposure techniques is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-codes-standards' style={{ color: '#dc2626' }}>&larr; RT Codes and Standards</a>
        <a href='/rt-image-quality' style={{ color: '#dc2626' }}>RT Image Quality Assessment &rarr;</a>
      </div>
    </div>
  );
}
