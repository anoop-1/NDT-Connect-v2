...
export const metadata: Metadata = {
  title: {
    default: 'RT Testing Hub - Radiographic Testing Knowledge Center',
    template: '%s | RT Testing Hub',
  },
  ...
  keywords: ['NDT', 'non-destructive testing', 'rt testing hub', 'inspection'],
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang='en'>
      ...
      <body>
        <header style={{ borderBottom: '3px solid #dc2626', padding: '16px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <a href='/' style={{ fontWeight: 'bold', fontSize: '1.2rem', color: '#dc2626', textDecoration: 'none' }}>RT Testing Hub</a>
          <nav style={{ display: 'flex', gap: '16px', fontSize: '0.9rem' }}>
            <a href='/' style={{ color: '#555', textDecoration: 'none' }}>Home</a>
            <a href='https://ndt-connect.com' target='_blank' rel='noopener' style={{ color: '#dc2626', textDecoration: 'none', fontWeight: 600 }}>NDT Connect</a>
          </nav>
        </header>
        ...
        <footer style={{ borderTop: '1px solid #e5e7eb', padding: '32px 24px', marginTop: '48px', textAlign: 'center', color: '#888', fontSize: '0.85rem' }}>
          <p>&copy; 2026 RT Testing Hub. An educational resource by <a href='https://ndt-connect.com' target='_blank' rel='noopener' style={{ color: '#dc2626' }}>NDT Connect</a>.</p>
