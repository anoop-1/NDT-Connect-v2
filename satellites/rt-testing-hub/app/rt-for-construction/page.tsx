...
export const metadata: Metadata = {
  title: 'RT in Construction Inspection',
  description: 'Radiographic testing applications in structural steel and reinforced concrete construction.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-for-construction' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT in Construction Inspection</span>
      </nav>

      <h1>RT in Construction Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Radiographic testing applications in structural steel and reinforced concrete construction.</p>
      ...
      <h2>Overview</h2>
      <p>Radiographic testing applications in structural steel and reinforced concrete construction. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndtconnect.com/industries' target='_blank' rel='noopener'>NDT Industries</a>. Learn more about <a href='https://ndtconnect.com/services/radiographic-testing' target='_blank' rel='noopener'>Radiographic Testing Services</a>. Learn more about <a href='https://ndtconnect.com/industries/oil-and-gas' target='_blank' rel='noopener'>Oil & Gas NDT</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt in construction inspection is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndtconnect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndtconnect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndtconnect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-training-certification' style={{ color: '#dc2626' }}>&larr; RT Training and Certification</a>
        <a href='/rt-advanced-imaging' style={{ color: '#dc2626' }}>Advanced RT Imaging Techniques &rarr;</a>
      </div>
    </div>
  );
}
