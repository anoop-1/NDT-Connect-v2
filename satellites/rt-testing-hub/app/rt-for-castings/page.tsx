...
export const metadata: Metadata = {
  title: 'RT Inspection of Castings',
  description: 'Radiographic examination of cast components including reference radiograph comparison per ASTM E446.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-for-castings' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT Inspection of Castings</span>
      </nav>

      <h1>RT Inspection of Castings</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Radiographic examination of cast components including reference radiograph comparison per ASTM E446.</p>
      ...
      <h2>Overview</h2>
      <p>Radiographic examination of cast components including reference radiograph comparison per ASTM E446. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog/ultimate-guide-ultrasonic-testing' target='_blank' rel='noopener'>Ultrasonic Testing Guide</a>. Learn more about <a href='https://ndt-connect.com/services/phased-array-ut' target='_blank' rel='noopener'>Phased Array UT Services</a>. Learn more about <a href='https://ndt-connect.com/tools/ndt-method-selector' target='_blank' rel='noopener'>NDT Method Selector Tool</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt inspection of castings is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-for-pipelines' style={{ color: '#dc2626' }}>&larr; RT Pipeline Weld Inspection</a>
        <a href='/rt-for-pressure-vessels' style={{ color: '#dc2626' }}>RT for Pressure Vessel Welds &rarr;</a>
      </div>
    </div>
  );
}
