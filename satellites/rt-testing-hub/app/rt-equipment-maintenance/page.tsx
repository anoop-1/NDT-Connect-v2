...
export const metadata: Metadata = {
  title: 'RT Equipment Maintenance',
  description: 'Maintenance procedures for radiographic testing equipment including X-ray generators.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-equipment-maintenance' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT Equipment Maintenance</span>
      </nav>

      <h1>RT Equipment Maintenance</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Maintenance procedures for radiographic testing equipment including X-ray generators.</p>
      ...
      <h2>Overview</h2>
      <p>Maintenance procedures for radiographic testing equipment including X-ray generators. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/services' target='_blank' rel='noopener'>NDT Services</a>. Learn more about <a href='https://ndt-connect.com/blog/ultimate-guide-ultrasonic-testing' target='_blank' rel='noopener'>Ultrasonic Testing Guide</a>. Learn more about <a href='https://ndt-connect.com/services/eddy-current-testing' target='_blank' rel='noopener'>Eddy Current Testing</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt equipment maintenance is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-dose-calculation' style={{ color: '#dc2626' }}>&larr; RT Dose Calculation Methods</a>
        <a href='/rt-defect-classification' style={{ color: '#dc2626' }}>RT Defect Classification Guide &rarr;</a>
      </div>
    </div>
  );
}
