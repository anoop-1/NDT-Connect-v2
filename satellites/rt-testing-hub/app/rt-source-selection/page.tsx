...
export const metadata: Metadata = {
  title: 'RT Source Selection Guide',
  description: 'Choosing the right radiation source for radiographic testing including X-ray tubes, Ir-192, Co-60, and Se-75.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-source-selection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT Source Selection Guide</span>
      </nav>

      <h1>RT Source Selection Guide</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Choosing the right radiation source for radiographic testing including X-ray tubes, Ir-192, Co-60, and Se-75.</p>
      ...
      <h2>Overview</h2>
      <p>Choosing the right radiation source for radiographic testing including X-ray tubes, Ir-192, Co-60, and Se-75. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/tools/certification-pathway' target='_blank' rel='noopener'>Certification Pathway Planner</a>. Learn more about <a href='https://ndt-connect.com/case-studies' target='_blank' rel='noopener'>NDT Case Studies</a>. Learn more about <a href='https://ndt-connect.com/services/phased-array-ut' target='_blank' rel='noopener'>Phased Array UT Services</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt source selection guide is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-safety-procedures' style={{ color: '#dc2626' }}>&larr; RT Radiation Safety Procedures</a>
        <a href='/rt-weld-inspection' style={{ color: '#dc2626' }}>RT Weld Inspection Methods &rarr;</a>
      </div>
    </div>
  );
}
