...
export const metadata: Metadata = {
  title: 'RT Image Quality Assessment',
  description: 'Methods for assessing radiographic image quality including IQI placement, sensitivity, and density.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-image-quality' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT Image Quality Assessment</span>
      </nav>

      <h1>RT Image Quality Assessment</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Methods for assessing radiographic image quality including IQI placement, sensitivity, and density.</p>
      ...
      <h2>Overview</h2>
      <p>Methods for assessing radiographic image quality including IQI placement, sensitivity, and density. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/tools/certification-pathway' target='_blank' rel='noopener'>Certification Pathway Planner</a>. Learn more about <a href='https://ndt-connect.com/services/penetrant-testing' target='_blank' rel='noopener'>Penetrant Testing Services</a>. Learn more about <a href='https://ndt-connect.com/certifications/pcn-certification' target='_blank' rel='noopener'>PCN Certification</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt image quality assessment is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-exposure-techniques' style={{ color: '#dc2626' }}>&larr; RT Exposure Techniques</a>
        <a href='/rt-for-pipelines' style={{ color: '#dc2626' }}>RT Pipeline Weld Inspection &rarr;</a>
      </div>
    </div>
  );
}
