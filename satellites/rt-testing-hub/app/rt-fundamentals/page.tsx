...
export const metadata: Metadata = {
  ...
  description: 'Core principles of radiographic testing including radiation physics, image formation, and industrial applications.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-fundamentals' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Radiographic Testing Fundamentals</span>
      </nav>

      <h1>Radiographic Testing Fundamentals</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Core principles of radiographic testing including radiation physics, image formation, and industrial applications.</p>
      ...
      <h2>Overview</h2>
      <p>Core principles of radiographic testing including radiation physics, image formation, and industrial applications. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/services/acoustic-emission-testing' target='_blank' rel='noopener'>Acoustic Emission Testing</a>. Learn more about <a href='https://ndt-connect.com/blog/weld-inspection-complete-guide' target='_blank' rel='noopener'>Weld Inspection Guide</a>. Learn more about <a href='https://ndt-connect.com/services' target='_blank' rel='noopener'>NDT Services</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding radiographic testing fundamentals is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <span></span>
        <a href='/rt-film-interpretation' style={{ color: '#dc2626' }}>RT Film Interpretation Guide &rarr;</a>
      </div>
    </div>
  );
}
