...
export const metadata: Metadata = {
  ...
  description: 'Panoramic radiographic techniques for circumferential weld inspection in vessels and piping.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-panoramic-techniques' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Panoramic Radiography</span>
      </nav>

      <h1>Panoramic Radiography</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Panoramic radiographic techniques for circumferential weld inspection in vessels and piping.</p>
      ...
      <h2>Overview</h2>
      <p>Panoramic radiographic techniques for circumferential weld inspection in vessels and piping. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/industries/oil-and-gas' target='_blank' rel='noopener'>Oil & Gas NDT</a>. Learn more about <a href='https://ndt-connect.com/industries/construction' target='_blank' rel='noopener'>Construction NDT</a>. Learn more about <a href='https://ndt-connect.com/blog/choosing-ndt-service-provider' target='_blank' rel='noopener'>Choosing NDT Provider</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding panoramic radiography is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-vs-other-methods' style={{ color: '#dc2626' }}>&larr; RT vs Other NDT Methods</a>
        <a href='/rt-profile-radiography' style={{ color: '#dc2626' }}>Profile and Tangential RT &rarr;</a>
      </div>
    </div>
  );
}
