...
export const metadata: Metadata = {
  title: 'RT in Aerospace Inspection',
  description: 'Aerospace-specific radiographic testing requirements and methods for aircraft component inspection.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-for-aerospace' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT in Aerospace Inspection</span>
      </nav>

      <h1>RT in Aerospace Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Aerospace-specific radiographic testing requirements and methods for aircraft component inspection.</p>
      ...
      <h2>Overview</h2>
      <p>Aerospace-specific radiographic testing requirements and methods for aircraft component inspection. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/industries/manufacturing' target='_blank' rel='noopener'>Manufacturing NDT</a>. Learn more about <a href='https://ndt-connect.com/contact' target='_blank' rel='noopener'>Contact NDT Connect</a>. Learn more about <a href='https://ndt-connect.com/services/ultrasonic-testing' target='_blank' rel='noopener'>Ultrasonic Testing Services</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt in aerospace inspection is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-backscatter-techniques' style={{ color: '#dc2626' }}>&larr; RT Backscatter Techniques</a>
        <a href='/rt-for-electronics' style={{ color: '#dc2626' }}>RT for Electronics Inspection &rarr;</a>
      </div>
    </div>
  );
}
