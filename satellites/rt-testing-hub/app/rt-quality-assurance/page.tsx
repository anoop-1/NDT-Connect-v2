...
export const metadata: Metadata = {
  title: 'RT Quality Assurance Programs',
  description: 'Establishing quality assurance programs for radiographic testing operations.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-quality-assurance' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT Quality Assurance Programs</span>
      </nav>

      <h1>RT Quality Assurance Programs</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Establishing quality assurance programs for radiographic testing operations.</p>
      ...
      <h2>Overview</h2>
      <p>Establishing quality assurance programs for radiographic testing operations. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndtconnect.com/certifications/asnt-certification' target='_blank' rel='noopener'>ASNT Certification</a>. Learn more about <a href='https://ndtconnect.com/certifications' target='_blank' rel='noopener'>NDT Certifications</a>. Learn more about <a href='https://ndtconnect.com/services/magnetic-flux-leakage' target='_blank' rel='noopener'>Magnetic Flux Leakage Testing</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt quality assurance programs is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndtconnect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndtconnect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndtconnect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-advanced-imaging' style={{ color: '#dc2626' }}>&larr; Advanced RT Imaging Techniques</a>
        <a href='/rt-environmental-concerns' style={{ color: '#dc2626' }}>RT Environmental Considerations &rarr;</a>
      </div>
    </div>
  );
}
