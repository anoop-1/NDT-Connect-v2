...
export const metadata: Metadata = {
  title: 'Advanced RT Imaging Techniques',
  description: 'Advanced radiographic imaging including laminography, stereo radiography, and phase contrast.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-advanced-imaging' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Advanced RT Imaging Techniques</span>
      </nav>

      <h1>Advanced RT Imaging Techniques</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Advanced radiographic imaging including laminography, stereo radiography, and phase contrast.</p>
      ...
      <h2>Overview</h2>
      <p>Advanced radiographic imaging including laminography, stereo radiography, and phase contrast. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog/ultimate-guide-ultrasonic-testing' target='_blank' rel='noopener'>Ultrasonic Testing Guide</a>. Learn more about <a href='https://ndt-connect.com/services/tofd-testing' target='_blank' rel='noopener'>TOFD Testing Services</a>. Learn more about <a href='https://ndt-connect.com/services/magnetic-particle-testing' target='_blank' rel='noopener'>Magnetic Particle Testing</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding advanced rt imaging techniques is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-for-construction' style={{ color: '#dc2626' }}>&larr; RT in Construction Inspection</a>
        <a href='/rt-quality-assurance' style={{ color: '#dc2626' }}>RT Quality Assurance Programs &rarr;</a>
      </div>
    </div>
  );
}
