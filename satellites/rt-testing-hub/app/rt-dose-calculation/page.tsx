...
export const metadata: Metadata = {
  title: 'RT Dose Calculation Methods',
  description: 'Methods for calculating radiation dose rates, exclusion zones, and exposure times.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-dose-calculation' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT Dose Calculation Methods</span>
      </nav>

      <h1>RT Dose Calculation Methods</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Methods for calculating radiation dose rates, exclusion zones, and exposure times.</p>
      ...
      <h2>Overview</h2>
      <p>Methods for calculating radiation dose rates, exclusion zones, and exposure times. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/tools/ndt-method-selector' target='_blank' rel='noopener'>NDT Method Selector Tool</a>. Learn more about <a href='https://ndt-connect.com/blog/choosing-ndt-service-provider' target='_blank' rel='noopener'>Choosing NDT Provider</a>. Learn more about <a href='https://ndt-connect.com/certifications/iso-9712' target='_blank' rel='noopener'>ISO 9712 Certification</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt dose calculation methods is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-for-electronics' style={{ color: '#dc2626' }}>&larr; RT for Electronics Inspection</a>
        <a href='/rt-equipment-maintenance' style={{ color: '#dc2626' }}>RT Equipment Maintenance &rarr;</a>
      </div>
    </div>
  );
}
