...
export default function Page() {
  return (
    <div>
      ...
      <h2>Overview</h2>
      <p>Computed tomography scanning for industrial NDT applications including 3D visualization. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndtconnect.com/industries/construction' target='_blank' rel='noopener'>Construction NDT</a>. Learn more about <a href='https://ndtconnect.com/services/ultrasonic-testing' target='_blank' rel='noopener'>Ultrasonic Testing Services</a>. Learn more about <a href='https://ndtconnect.com/case-studies' target='_blank' rel='noopener'>NDT Case Studies</a>.</p>
