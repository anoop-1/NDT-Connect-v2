...
export default function Page() {
  return (
    <div>
      ...
      <h2>Overview</h2>
      <p>Overview of digital radiography technology, detector types, image quality, and advantages over conventional film. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndtconnect.com/certifications/pcn-certification' target='_blank' rel='noopener'>PCN Certification</a>. Learn more about <a href='https://ndtconnect.com/services/corrosion-mapping' target='_blank' rel='noopener'>Corrosion Mapping Services</a>. Learn more about <a href='https://ndtconnect.com/blog/pipeline-inspection-techniques' target='_blank' rel='noopener'>Pipeline Inspection</a>.</p>
