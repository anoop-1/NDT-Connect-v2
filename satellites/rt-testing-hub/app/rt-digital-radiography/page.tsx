...
export const metadata: Metadata = {
  title: 'Digital Radiography Guide',
  description: 'Overview of digital radiography technology, detector types, image quality, and advantages over conventional film.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-digital-radiography' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Digital Radiography Guide</span>
      </nav>

      <h1>Digital Radiography Guide</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Overview of digital radiography technology, detector types, image quality, and advantages over conventional film.</p>
      ...
      <h2>Overview</h2>
      <p>Overview of digital radiography technology, detector types, image quality, and advantages over conventional film. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/certifications/pcn-certification' target='_blank' rel='noopener'>PCN Certification</a>. Learn more about <a href='https://ndt-connect.com/services/corrosion-mapping' target='_blank' rel='noopener'>Corrosion Mapping Services</a>. Learn more about <a href='https://ndt-connect.com/blog/pipeline-inspection-techniques' target='_blank' rel='noopener'>Pipeline Inspection</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding digital radiography guide is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-film-interpretation' style={{ color: '#dc2626' }}>&larr; RT Film Interpretation Guide</a>
        <a href='/rt-computed-radiography' style={{ color: '#dc2626' }}>Computed Radiography Explained &rarr;</a>
      </div>
    </div>
  );
}
