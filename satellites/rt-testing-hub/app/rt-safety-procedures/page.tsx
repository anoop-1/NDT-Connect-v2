...
export const metadata: Metadata = {
  title: 'RT Radiation Safety Procedures',
  description: 'Essential radiation safety protocols for radiographic testing including ALARA principles and monitoring.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-safety-procedures' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT Radiation Safety Procedures</span>
      </nav>

      <h1>RT Radiation Safety Procedures</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Essential radiation safety protocols for radiographic testing including ALARA principles and monitoring.</p>
      ...
      <h2>Overview</h2>
      <p>Essential radiation safety protocols for radiographic testing including ALARA principles and monitoring. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog/ultimate-guide-ultrasonic-testing' target='_blank' rel='noopener'>Ultrasonic Testing Guide</a>. Learn more about <a href='https://ndt-connect.com/faq' target='_blank' rel='noopener'>NDT FAQ</a>. Learn more about <a href='https://ndt-connect.com/industries/construction' target='_blank' rel='noopener'>Construction NDT</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt radiation safety procedures is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-computed-radiography' style={{ color: '#dc2626' }}>&larr; Computed Radiography Explained</a>
        <a href='/rt-source-selection' style={{ color: '#dc2626' }}>RT Source Selection Guide &rarr;</a>
      </div>
    </div>
  );
}
