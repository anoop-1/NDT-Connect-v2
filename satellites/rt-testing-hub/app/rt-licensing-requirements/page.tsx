...
export const metadata: Metadata = {
  ...
  description: 'Overview of regulatory licensing requirements for radiographic testing operations and radiation sources.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-licensing-requirements' },
};
...
export default function Page() {
  return (
    <div>
      ...
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Overview of regulatory licensing requirements for radiographic testing operations and radiation sources.</p>
      ...
      <h2>Overview</h2>
      <p>Overview of regulatory licensing requirements for radiographic testing operations and radiation sources. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog/ndt-industry-statistics' target='_blank' rel='noopener'>NDT Industry Statistics</a>. Learn more about <a href='https://ndt-connect.com/services/corrosion-mapping' target='_blank' rel='noopener'>Corrosion Mapping Services</a>. Learn more about <a href='https://ndt-connect.com/blog/weld-inspection-complete-guide' target='_blank' rel='noopener'>Weld Inspection Guide</a>.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-film-processing' style={{ color: '#dc2626' }}>&larr; RT Film Processing and Handling</a>
        <a href='/rt-vs-other-methods' style={{ color: '#dc2626' }}>RT vs Other NDT Methods &rarr;</a>
      </div>
    </div>
  );
}
