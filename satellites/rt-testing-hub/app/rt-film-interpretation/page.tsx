...
export const metadata: Metadata = {
  title: 'RT Film Interpretation Guide',
  description: 'Comprehensive guide to radiographic film interpretation including weld discontinuities and casting defects.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-film-interpretation' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT Film Interpretation Guide</span>
      </nav>

      <h1>RT Film Interpretation Guide</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to radiographic film interpretation including weld discontinuities and casting defects.</p>
      ...
      <h2>Overview</h2>
      <p>Comprehensive guide to radiographic film interpretation including weld discontinuities and casting defects. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog/ndt-career-guide-2026' target='_blank' rel='noopener'>NDT Career Guide</a>. Learn more about <a href='https://ndt-connect.com/certifications/api-653' target='_blank' rel='noopener'>API 653 Certification</a>. Learn more about <a href='https://ndt-connect.com/services/tofd-testing' target='_blank' rel='noopener'>TOFD Testing Services</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt film interpretation guide is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-fundamentals' style={{ color: '#dc2626' }}>&larr; Radiographic Testing Fundamentals</a>
        <a href='/rt-digital-radiography' style={{ color: '#dc2626' }}>Digital Radiography Guide &rarr;</a>
      </div>
    </div>
  );
}
