...
export const metadata: Metadata = {
  title: 'RT Defect Classification Guide',
  description: 'Classifying weld and casting defects found in radiographic images per industry standards.',
  alternates: { canonical: 'https://rt-testing-hub.vercel.app/rt-defect-classification' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT Defect Classification Guide</span>
      </nav>

      <h1>RT Defect Classification Guide</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Classifying weld and casting defects found in radiographic images per industry standards.</p>
      ...
      <h2>Overview</h2>
      <p>Classifying weld and casting defects found in radiographic images per industry standards. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog' target='_blank' rel='noopener'>NDT Blog</a>. Learn more about <a href='https://ndt-connect.com/industries/manufacturing' target='_blank' rel='noopener'>Manufacturing NDT</a>. Learn more about <a href='https://ndt-connect.com/certifications/api-653' target='_blank' rel='noopener'>API 653 Certification</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding rt defect classification guide is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/rt-equipment-maintenance' style={{ color: '#dc2626' }}>&larr; RT Equipment Maintenance</a>
        <a href='/rt-for-corrosion' style={{ color: '#dc2626' }}>RT for Corrosion Detection &rarr;</a>
      </div>
    </div>
  );
}
