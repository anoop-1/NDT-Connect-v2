...
export const metadata: Metadata = {
  title: 'Pressure Vessel Rerating',
  description: 'Comprehensive guide to pressure vessel rerating for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://pressure-vessel-inspection.vercel.app/pv-rerating' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Pressure Vessel Rerating</span>
      </nav>

      <h1>Pressure Vessel Rerating</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to pressure vessel rerating for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <h2>Overview</h2>
      <p>Comprehensive guide to pressure vessel rerating for NDT professionals in industrial inspection and asset integrity management. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog' target='_blank' rel='noopener'>NDT Blog</a>. Learn more about <a href='https://ndt-connect.com/blog/choosing-ndt-service-provider' target='_blank' rel='noopener'>Choosing NDT Provider</a>. Learn more about <a href='https://ndt-connect.com/services/penetrant-testing' target='_blank' rel='noopener'>Penetrant Testing Services</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding pressure vessel rerating is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/pv-repair-alteration' style={{ color: '#b91c1c' }}>&larr; PV Repair and Alteration</a>
        <a href='/pv-heat-exchanger' style={{ color: '#b91c1c' }}>Heat Exchanger Inspection &rarr;</a>
      </div>
    </div>
  );
}
