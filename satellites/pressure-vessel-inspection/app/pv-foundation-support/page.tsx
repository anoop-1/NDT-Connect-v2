...
export const metadata: Metadata = {
  title: 'PV Foundation Inspection',
  description: 'Comprehensive guide to pv foundation inspection for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://pressure-vessel-inspection.vercel.app/pv-foundation-support' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>PV Foundation Inspection</span>
      </nav>

      <h1>PV Foundation Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to pv foundation inspection for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/pv-cladded-vessels' style={{ color: '#b91c1c' }}>&larr; Cladded Vessel Inspection</a>
        <a href='/pv-corrosion-monitoring' style={{ color: '#b91c1c' }}>PV Corrosion Monitoring &rarr;</a>
      </div>
    </div>
  );
}
