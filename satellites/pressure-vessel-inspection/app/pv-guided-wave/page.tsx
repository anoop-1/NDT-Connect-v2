...
export const metadata: Metadata = {
  title: 'Guided Wave for PV',
  description: 'Comprehensive guide to guided wave for pv for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://pressure-vessel-inspection.vercel.app/pv-guided-wave' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Guided Wave for PV</span>
      </nav>

      <h1>Guided Wave for PV</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to guided wave for pv for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/pv-phased-array' style={{ color: '#b91c1c' }}>&larr; Phased Array for PV</a>
        <a href='/pv-acoustic-emission' style={{ color: '#b91c1c' }}>AE Testing for PV &rarr;</a>
      </div>
    </div>
  );
}
