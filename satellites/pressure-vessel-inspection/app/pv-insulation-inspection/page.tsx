...
export const metadata: Metadata = {
  title: 'Insulated PV Inspection',
  description: 'Comprehensive guide to insulated pv inspection for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://pressure-vessel-inspection.vercel.app/pv-insulation-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Insulated PV Inspection</span>
      </nav>

      <h1>Insulated PV Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to insulated pv inspection for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/pv-relief-devices' style={{ color: '#b91c1c' }}>&larr; Relief Device Inspection</a>
        <a href='/pv-elevated-temperature' style={{ color: '#b91c1c' }}>High Temperature PV Inspection &rarr;</a>
      </div>
    </div>
  );
}
