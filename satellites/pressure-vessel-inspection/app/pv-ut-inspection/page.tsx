...
export const metadata: Metadata = {
  title: 'UT for Pressure Vessels',
  description: 'Comprehensive guide to ut for pressure vessels for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://pressure-vessel-inspection.vercel.app/pv-ut-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>UT for Pressure Vessels</span>
      </nav>

      <h1>UT for Pressure Vessels</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to ut for pressure vessels for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/pv-damage-mechanisms' style={{ color: '#b91c1c' }}>&larr; PV Damage Mechanisms</a>
        <a href='/pv-rt-inspection' style={{ color: '#b91c1c' }}>RT for Pressure Vessels &rarr;</a>
      </div>
    </div>
  );
}
