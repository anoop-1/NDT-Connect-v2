...
export const metadata: Metadata = {
  title: 'Boiler Inspection Guide',
  description: 'Comprehensive guide to boiler inspection guide for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://pressure-vessel-inspection.vercel.app/pv-boiler-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Boiler Inspection Guide</span>
      </nav>

      <h1>Boiler Inspection Guide</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to boiler inspection guide for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/pv-heat-exchanger' style={{ color: '#b91c1c' }}>&larr; Heat Exchanger Inspection</a>
        <a href='/pv-nozzle-inspection' style={{ color: '#b91c1c' }}>Nozzle Inspection &rarr;</a>
      </div>
    </div>
  );
}
