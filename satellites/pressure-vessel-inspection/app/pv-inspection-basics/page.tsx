...
export const metadata: Metadata = {
  title: 'PV Inspection Basics',
  description: 'Comprehensive guide to pv inspection basics for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://pressure-vessel-inspection.vercel.app/pv-inspection-basics' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>PV Inspection Basics</span>
      </nav>

      <h1>PV Inspection Basics</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to pv inspection basics for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <span></span>
        <a href='/pv-api-510-guide' style={{ color: '#b91c1c' }}>API 510 Inspection Guide &rarr;</a>
      </div>
    </div>
  );
}
