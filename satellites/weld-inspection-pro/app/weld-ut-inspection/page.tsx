...
export const metadata: Metadata = {
  ...
  description: 'Ultrasonic testing techniques for weld inspection including angle beam methods and acceptance criteria.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-ut-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Ultrasonic Weld Inspection</span>
      </nav>

      <h1>Ultrasonic Weld Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Ultrasonic testing techniques for weld inspection including angle beam methods and acceptance criteria.</p>
      ...
      <h2>Overview</h2>
      <p>Ultrasonic testing techniques for weld inspection including angle beam methods and acceptance criteria. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog/choosing-ndt-service-provider' target='_blank' rel='noopener'>Choosing NDT Provider</a>. Learn more about <a href='https://ndt-connect.com/tools/certification-pathway' target='_blank' rel='noopener'>Certification Pathway Planner</a>. Learn more about <a href='https://ndt-connect.com/industries/construction' target='_blank' rel='noopener'>Construction NDT</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding ultrasonic weld inspection is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-defect-types' style={{ color: '#d97706' }}>&larr; Common Weld Defect Types</a>
        <a href='/weld-rt-inspection' style={{ color: '#d97706' }}>Radiographic Weld Inspection &rarr;</a>
      </div>
    </div>
  );
}
