...
export const metadata: Metadata = {
  title: 'CWI Exam Preparation Guide',
  description: 'Study guide for the AWS Certified Welding Inspector examination.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/cwi-exam-preparation' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>CWI Exam Preparation Guide</span>
      </nav>

      <h1>CWI Exam Preparation Guide</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Study guide for the AWS Certified Welding Inspector examination.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-procedure-qualification' style={{ color: '#d97706' }}>&larr; WPS and PQR Development</a>
        <a href='/weld-heat-treatment' style={{ color: '#d97706' }}>Post-Weld Heat Treatment &rarr;</a>
      </div>
    </div>
  );
}
