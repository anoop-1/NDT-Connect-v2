...
export const metadata: Metadata = {
  ...
  description: 'Methods for preventing and correcting welding distortion in fabrication.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-distortion-control' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Weld Distortion Control</span>
      </nav>

      <h1>Weld Distortion Control</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Methods for preventing and correcting welding distortion in fabrication.</p>
      ...
      <h2>Overview</h2>
      <p>Methods for preventing and correcting welding distortion in fabrication. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/tools/inspection-cost-estimator' target='_blank' rel='noopener'>NDT Cost Estimator</a>. Learn more about <a href='https://ndt-connect.com/tools/ndt-method-selector' target='_blank' rel='noopener'>NDT Method Selector Tool</a>. Learn more about <a href='https://ndt-connect.com/blog/choosing-ndt-service-provider' target='_blank' rel='noopener'>Choosing NDT Provider</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding weld distortion control is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-repair-procedures' style={{ color: '#d97706' }}>&larr; Weld Repair Procedures</a>
        <a href='/weld-for-pressure-vessels' style={{ color: '#d97706' }}>Pressure Vessel Weld Inspection &rarr;</a>
      </div>
    </div>
  );
}
