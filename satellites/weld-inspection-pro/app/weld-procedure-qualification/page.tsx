...
export const metadata: Metadata = {
  title: 'WPS and PQR Development',
  description: 'Process for developing welding procedure specifications and procedure qualification records.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-procedure-qualification' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>WPS and PQR Development</span>
      </nav>

      <h1>WPS and PQR Development</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Process for developing welding procedure specifications and procedure qualification records.</p>
      ...
      <h2>Overview</h2>
      <p>Process for developing welding procedure specifications and procedure qualification records. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/industries/oil-and-gas' target='_blank' rel='noopener'>Oil & Gas NDT</a>. Learn more about <a href='https://ndt-connect.com/industries/manufacturing' target='_blank' rel='noopener'>Manufacturing NDT</a>. Learn more about <a href='https://ndt-connect.com/certifications/iso-9712' target='_blank' rel='noopener'>ISO 9712 Certification</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding wps and pqr development is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-symbol-reading' style={{ color: '#d97706' }}>&larr; Reading Welding Symbols</a>
        <a href='/cwi-exam-preparation' style={{ color: '#d97706' }}>CWI Exam Preparation Guide &rarr;</a>
      </div>
    </div>
  );
}
