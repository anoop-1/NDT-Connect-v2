...
export const metadata: Metadata = {
  title: 'ASME Section IX Overview',
  description: 'Overview of ASME Section IX welding qualification requirements including WPS, PQR, and welder performance.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/asme-section-ix' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>ASME Section IX Overview</span>
      </nav>

      <h1>ASME Section IX Overview</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Overview of ASME Section IX welding qualification requirements including WPS, PQR, and welder performance.</p>
      ...
      <h2>Overview</h2>
      <p>Overview of ASME Section IX welding qualification requirements including WPS, PQR, and welder performance. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/industries/manufacturing' target='_blank' rel='noopener'>Manufacturing NDT</a>. Learn more about <a href='https://ndt-connect.com/services' target='_blank' rel='noopener'>NDT Services</a>. Learn more about <a href='https://ndt-connect.com/certifications/asnt-certification' target='_blank' rel='noopener'>ASNT Certification</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding asme section ix overview is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/aws-d1-1-guide' style={{ color: '#d97706' }}>&larr; AWS D1.1 Structural Welding Guide</a>
        <a href='/weld-joint-design' style={{ color: '#d97706' }}>Weld Joint Design and Preparation &rarr;</a>
      </div>
    </div>
  );
}
