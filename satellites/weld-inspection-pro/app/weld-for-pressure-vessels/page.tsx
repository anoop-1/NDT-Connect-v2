...
export const metadata: Metadata = {
  title: 'Pressure Vessel Weld Inspection',
  description: 'Weld inspection requirements for pressure vessels per ASME Section VIII.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-for-pressure-vessels' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Pressure Vessel Weld Inspection</span>
      </nav>

      <h1>Pressure Vessel Weld Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Weld inspection requirements for pressure vessels per ASME Section VIII.</p>
      ...
      <h2>Overview</h2>
      <p>Weld inspection requirements for pressure vessels per ASME Section VIII. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/services/tofd-testing' target='_blank' rel='noopener'>TOFD Testing Services</a>. Learn more about <a href='https://ndt-connect.com/industries/construction' target='_blank' rel='noopener'>Construction NDT</a>. Learn more about <a href='https://ndt-connect.com/industries/oil-and-gas' target='_blank' rel='noopener'>Oil & Gas NDT</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding pressure vessel weld inspection is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-distortion-control' style={{ color: '#d97706' }}>&larr; Weld Distortion Control</a>
        <a href='/weld-for-pipelines' style={{ color: '#d97706' }}>Pipeline Weld Inspection &rarr;</a>
      </div>
    </div>
  );
}
