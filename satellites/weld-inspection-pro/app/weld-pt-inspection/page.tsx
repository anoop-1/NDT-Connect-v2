...
export const metadata: Metadata = {
  title: 'Penetrant Testing for Welds',
  description: 'Liquid penetrant testing methods for detecting surface-breaking defects in welds.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-pt-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Penetrant Testing for Welds</span>
      </nav>

      <h1>Penetrant Testing for Welds</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Liquid penetrant testing methods for detecting surface-breaking defects in welds.</p>
      ...
      <h2>Overview</h2>
      <p>Liquid penetrant testing methods for detecting surface-breaking defects in welds. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog/corrosion-under-insulation-guide' target='_blank' rel='noopener'>CUI Guide</a>. Learn more about <a href='https://ndt-connect.com/blog/ndt-digital-twins-guide' target='_blank' rel='noopener'>NDT Digital Twins</a>. Learn more about <a href='https://ndt-connect.com/blog/ndt-career-guide-2026' target='_blank' rel='noopener'>NDT Career Guide</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding penetrant testing for welds is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-mt-inspection' style={{ color: '#d97706' }}>&larr; Magnetic Particle Weld Testing</a>
        <a href='/aws-d1-1-guide' style={{ color: '#d97706' }}>AWS D1.1 Structural Welding Guide &rarr;</a>
      </div>
    </div>
  );
}
