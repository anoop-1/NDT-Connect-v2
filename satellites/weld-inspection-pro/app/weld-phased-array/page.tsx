...
export const metadata: Metadata = {
  title: 'Phased Array for Weld Inspection',
  description: 'Application of phased array ultrasonic testing for weld inspection.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-phased-array' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Phased Array for Weld Inspection</span>
      </nav>

      <h1>Phased Array for Weld Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Application of phased array ultrasonic testing for weld inspection.</p>
      ...
      <h2>Overview</h2>
      <p>Application of phased array ultrasonic testing for weld inspection. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/certifications' target='_blank' rel='noopener'>NDT Certifications</a>. Learn more about <a href='https://ndt-connect.com/tools/inspection-cost-estimator' target='_blank' rel='noopener'>NDT Cost Estimator</a>. Learn more about <a href='https://ndt-connect.com/find-providers' target='_blank' rel='noopener'>Find NDT Providers</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding phased array for weld inspection is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-fatigue-assessment' style={{ color: '#d97706' }}>&larr; Weld Fatigue Life Assessment</a>
        <a href='/weld-tofd' style={{ color: '#d97706' }}>TOFD for Weld Inspection &rarr;</a>
      </div>
    </div>
  );
}
