...
export const metadata: Metadata = {
  title: 'Weld Acceptance Criteria Comparison',
  description: 'Comparing weld acceptance criteria across AWS, ASME, API, and EN standards.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-acceptance-criteria' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Weld Acceptance Criteria Comparison</span>
      </nav>

      <h1>Weld Acceptance Criteria Comparison</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comparing weld acceptance criteria across AWS, ASME, API, and EN standards.</p>
      ...
      <h2>Overview</h2>
      <p>Comparing weld acceptance criteria across AWS, ASME, API, and EN standards. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog/ndt-industry-statistics' target='_blank' rel='noopener'>NDT Industry Statistics</a>. Learn more about <a href='https://ndt-connect.com/tools/inspection-cost-estimator' target='_blank' rel='noopener'>NDT Cost Estimator</a>. Learn more about <a href='https://ndt-connect.com/blog/ndt-certifications-explained' target='_blank' rel='noopener'>NDT Certifications Explained</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding weld acceptance criteria comparison is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-documentation' style={{ color: '#d97706' }}>&larr; Weld Inspection Documentation</a>
        <a href='/weld-process-selection' style={{ color: '#d97706' }}>Welding Process Selection &rarr;</a>
      </div>
    </div>
  );
}
