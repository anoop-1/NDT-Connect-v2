...
export const metadata: Metadata = {
  title: 'Radiographic Weld Inspection',
  description: 'Radiographic testing procedures for weld quality assessment including setup and interpretation.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-rt-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Radiographic Weld Inspection</span>
      </nav>

      <h1>Radiographic Weld Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Radiographic testing procedures for weld quality assessment including setup and interpretation.</p>
      ...
      <h2>Overview</h2>
      <p>Radiographic testing procedures for weld quality assessment including setup and interpretation. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/industries' target='_blank' rel='noopener'>NDT Industries</a>. Learn more about <a href='https://ndt-connect.com/certifications/api-653' target='_blank' rel='noopener'>API 653 Certification</a>. Learn more about <a href='https://ndt-connect.com/blog/ndt-certifications-explained' target='_blank' rel='noopener'>NDT Certifications Explained</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding radiographic weld inspection is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-ut-inspection' style={{ color: '#d97706' }}>&larr; Ultrasonic Weld Inspection</a>
        <a href='/weld-mt-inspection' style={{ color: '#d97706' }}>Magnetic Particle Weld Testing &rarr;</a>
      </div>
    </div>
  );
}
