...
export const metadata: Metadata = {
  ...
  description: 'Methods for assessing fatigue life of welded joints including fracture mechanics.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-fatigue-assessment' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Weld Fatigue Life Assessment</span>
      </nav>

      <h1>Weld Fatigue Life Assessment</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Methods for assessing fatigue life of welded joints including fracture mechanics.</p>
      ...
      <h2>Overview</h2>
      <p>Methods for assessing fatigue life of welded joints including fracture mechanics. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/industries' target='_blank' rel='noopener'>NDT Industries</a>. Learn more about <a href='https://ndt-connect.com/services/visual-testing' target='_blank' rel='noopener'>Visual Testing Services</a>. Learn more about <a href='https://ndt-connect.com/blog/ndt-certifications-explained' target='_blank' rel='noopener'>NDT Certifications Explained</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding weld fatigue life assessment is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-hydrogen-cracking' style={{ color: '#d97706' }}>&larr; Hydrogen Induced Cracking in Welds</a>
        <a href='/weld-phased-array' style={{ color: '#d97706' }}>Phased Array for Weld Inspection &rarr;</a>
      </div>
    </div>
  );
}
