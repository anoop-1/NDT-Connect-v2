...
export const metadata: Metadata = {
  title: 'Magnetic Particle Weld Testing',
  description: 'Magnetic particle testing procedures for surface and near-surface weld defect detection.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-mt-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Magnetic Particle Weld Testing</span>
      </nav>

      <h1>Magnetic Particle Weld Testing</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Magnetic particle testing procedures for surface and near-surface weld defect detection.</p>
      ...
      <h2>Overview</h2>
      <p>Magnetic particle testing procedures for surface and near-surface weld defect detection. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/industries/oil-and-gas' target='_blank' rel='noopener'>Oil & Gas NDT</a>. Learn more about <a href='https://ndt-connect.com/services/magnetic-particle-testing' target='_blank' rel='noopener'>Magnetic Particle Testing</a>. Learn more about <a href='https://ndt-connect.com/certifications/pcn-certification' target='_blank' rel='noopener'>PCN Certification</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding magnetic particle weld testing is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-rt-inspection' style={{ color: '#d97706' }}>&larr; Radiographic Weld Inspection</a>
        <a href='/weld-pt-inspection' style={{ color: '#d97706' }}>Penetrant Testing for Welds &rarr;</a>
      </div>
    </div>
  );
}
