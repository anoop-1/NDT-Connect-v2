...
export default function Page() {
  return (
    <div>
      ...
      <h2>Overview</h2>
      <p>Inspection requirements for structural steel welding in buildings and bridges. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndtconnect.com/contact' target='_blank' rel='noopener'>Contact NDT Connect</a>. Learn more about <a href='https://ndtconnect.com/services/eddy-current-testing' target='_blank' rel='noopener'>Eddy Current Testing</a>. Learn more about <a href='https://ndtconnect.com/blog/ut-vs-rt-comparison' target='_blank' rel='noopener'>UT vs RT Comparison</a>.</p>
