...
export const metadata: Metadata = {
  title: 'Welding Stainless Steel Inspection',
  description: 'Special inspection considerations for stainless steel welding.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-stainless-steel' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Welding Stainless Steel Inspection</span>
      </nav>

      <h1>Welding Stainless Steel Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Special inspection considerations for stainless steel welding.</p>
      ...
      <h2>Overview</h2>
      <p>Special inspection considerations for stainless steel welding. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/services/penetrant-testing' target='_blank' rel='noopener'>Penetrant Testing Services</a>. Learn more about <a href='https://ndt-connect.com/industries/oil-and-gas' target='_blank' rel='noopener'>Oil & Gas NDT</a>. Learn more about <a href='https://ndt-connect.com/blog/choosing-ndt-service-provider' target='_blank' rel='noopener'>Choosing NDT Provider</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding welding stainless steel inspection is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-preheat-requirements' style={{ color: '#d97706' }}>&larr; Weld Preheat Requirements</a>
        <a href='/weld-pipe-inspection' style={{ color: '#d97706' }}>Pipe Weld Inspection Guide &rarr;</a>
      </div>
    </div>
  );
}
