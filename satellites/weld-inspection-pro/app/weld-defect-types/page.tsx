...
export const metadata: Metadata = {
  title: 'Common Weld Defect Types',
  description: 'Identifying and classifying common weld defects including porosity, lack of fusion, and cracks.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-defect-types' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Common Weld Defect Types</span>
      </nav>

      <h1>Common Weld Defect Types</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Identifying and classifying common weld defects including porosity, lack of fusion, and cracks.</p>
      ...
      <h2>Overview</h2>
      <p>Identifying and classifying common weld defects including porosity, lack of fusion, and cracks. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/services/tofd-testing' target='_blank' rel='noopener'>TOFD Testing Services</a>. Learn more about <a href='https://ndt-connect.com/case-studies' target='_blank' rel='noopener'>NDT Case Studies</a>. Learn more about <a href='https://ndt-connect.com/blog/ultimate-guide-ultrasonic-testing' target='_blank' rel='noopener'>Ultrasonic Testing Guide</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding common weld defect types is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-vt-inspection' style={{ color: '#d97706' }}>&larr; Visual Weld Inspection Guide</a>
        <a href='/weld-ut-inspection' style={{ color: '#d97706' }}>Ultrasonic Weld Inspection &rarr;</a>
      </div>
    </div>
  );
}
