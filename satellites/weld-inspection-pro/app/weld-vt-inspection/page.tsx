...
export const metadata: Metadata = {
  title: 'Visual Weld Inspection Guide',
  description: 'Complete guide to visual weld inspection including tools, acceptance criteria, and documentation.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-vt-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Visual Weld Inspection Guide</span>
      </nav>

      <h1>Visual Weld Inspection Guide</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Complete guide to visual weld inspection including tools, acceptance criteria, and documentation.</p>
      ...
      <h2>Overview</h2>
      <p>Complete guide to visual weld inspection including tools, acceptance criteria, and documentation. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/tools/certification-pathway' target='_blank' rel='noopener'>Certification Pathway Planner</a>. Learn more about <a href='https://ndt-connect.com/certifications/iso-9712' target='_blank' rel='noopener'>ISO 9712 Certification</a>. Learn more about <a href='https://ndt-connect.com/services/eddy-current-testing' target='_blank' rel='noopener'>Eddy Current Testing</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding visual weld inspection guide is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <span></span>
        <a href='/weld-defect-types' style={{ color: '#d97706' }}>Common Weld Defect Types &rarr;</a>
      </div>
    </div>
  );
}
