...
export const metadata: Metadata = {
  title: 'Weld Quality Management Systems',
  description: 'Implementing quality management systems per ISO 3834.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-quality-management' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Weld Quality Management Systems</span>
      </nav>

      <h1>Weld Quality Management Systems</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Implementing quality management systems per ISO 3834.</p>
      ...
      <h2>Overview</h2>
      <p>Implementing quality management systems per ISO 3834. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/services/phased-array-ut' target='_blank' rel='noopener'>Phased Array UT Services</a>. Learn more about <a href='https://ndt-connect.com/certifications/api-570' target='_blank' rel='noopener'>API 570 Certification</a>. Learn more about <a href='https://ndt-connect.com/industries/manufacturing' target='_blank' rel='noopener'>Manufacturing NDT</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding weld quality management systems is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-ect-inspection' style={{ color: '#d97706' }}>&larr; Eddy Current Weld Inspection</a>
        <a href='/weld-filler-metal' style={{ color: '#d97706' }}>Filler Metal Selection Guide &rarr;</a>
      </div>
    </div>
  );
}
