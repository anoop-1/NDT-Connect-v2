...
export const metadata: Metadata = {
  title: 'Automated Weld Inspection',
  description: 'Overview of automated weld inspection systems including mechanized UT.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-automation' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Automated Weld Inspection</span>
      </nav>

      <h1>Automated Weld Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Overview of automated weld inspection systems including mechanized UT.</p>
      ...
      <h2>Overview</h2>
      <p>Overview of automated weld inspection systems including mechanized UT. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/industries/oil-and-gas' target='_blank' rel='noopener'>Oil & Gas NDT</a>. Learn more about <a href='https://ndt-connect.com/blog' target='_blank' rel='noopener'>NDT Blog</a>. Learn more about <a href='https://ndt-connect.com/blog/ultimate-guide-ultrasonic-testing' target='_blank' rel='noopener'>Ultrasonic Testing Guide</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding automated weld inspection is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-dissimilar-metals' style={{ color: '#d97706' }}>&larr; Dissimilar Metal Weld Inspection</a>
        <a href='/weld-documentation' style={{ color: '#d97706' }}>Weld Inspection Documentation &rarr;</a>
      </div>
    </div>
  );
}
