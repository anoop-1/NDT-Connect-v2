...
export const metadata: Metadata = {
  title: 'Eddy Current Weld Inspection',
  description: 'Application of eddy current testing for weld surface inspection.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-ect-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Eddy Current Weld Inspection</span>
      </nav>

      <h1>Eddy Current Weld Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Application of eddy current testing for weld surface inspection.</p>
      ...
      <h2>Overview</h2>
      <p>Application of eddy current testing for weld surface inspection. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog' target='_blank' rel='noopener'>NDT Blog</a>. Learn more about <a href='https://ndt-connect.com/services/magnetic-flux-leakage' target='_blank' rel='noopener'>Magnetic Flux Leakage Testing</a>. Learn more about <a href='https://ndt-connect.com/find-providers' target='_blank' rel='noopener'>Find NDT Providers</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding eddy current weld inspection is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-tofd' style={{ color: '#d97706' }}>&larr; TOFD for Weld Inspection</a>
        <a href='/weld-quality-management' style={{ color: '#d97706' }}>Weld Quality Management Systems &rarr;</a>
      </div>
    </div>
  );
}
