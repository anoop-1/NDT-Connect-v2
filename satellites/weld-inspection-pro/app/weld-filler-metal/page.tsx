...
export const metadata: Metadata = {
  title: 'Filler Metal Selection Guide',
  description: 'Selecting appropriate filler metals for welding applications.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-filler-metal' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Filler Metal Selection Guide</span>
      </nav>

      <h1>Filler Metal Selection Guide</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Selecting appropriate filler metals for welding applications.</p>
      ...
      <h2>Overview</h2>
      <p>Selecting appropriate filler metals for welding applications. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/industries/construction' target='_blank' rel='noopener'>Construction NDT</a>. Learn more about <a href='https://ndt-connect.com/blog/ndt-industry-statistics' target='_blank' rel='noopener'>NDT Industry Statistics</a>. Learn more about <a href='https://ndt-connect.com/faq' target='_blank' rel='noopener'>NDT FAQ</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding filler metal selection guide is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-quality-management' style={{ color: '#d97706' }}>&larr; Weld Quality Management Systems</a>
        <a href='/weld-welder-qualification' style={{ color: '#d97706' }}>Welder Performance Qualification &rarr;</a>
      </div>
    </div>
  );
}
