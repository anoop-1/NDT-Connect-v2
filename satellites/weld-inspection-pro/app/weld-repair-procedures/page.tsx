...
export const metadata: Metadata = {
  title: 'Weld Repair Procedures',
  description: 'Guidelines for weld repair including excavation methods and re-inspection.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-repair-procedures' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Weld Repair Procedures</span>
      </nav>

      <h1>Weld Repair Procedures</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Guidelines for weld repair including excavation methods and re-inspection.</p>
      ...
      <h2>Overview</h2>
      <p>Guidelines for weld repair including excavation methods and re-inspection. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/services/ultrasonic-testing' target='_blank' rel='noopener'>Ultrasonic Testing Services</a>. Learn more about <a href='https://ndt-connect.com/tools/certification-pathway' target='_blank' rel='noopener'>Certification Pathway Planner</a>. Learn more about <a href='https://ndt-connect.com/services/acoustic-emission-testing' target='_blank' rel='noopener'>Acoustic Emission Testing</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding weld repair procedures is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-structural-inspection' style={{ color: '#d97706' }}>&larr; Structural Weld Inspection</a>
        <a href='/weld-distortion-control' style={{ color: '#d97706' }}>Weld Distortion Control &rarr;</a>
      </div>
    </div>
  );
}
