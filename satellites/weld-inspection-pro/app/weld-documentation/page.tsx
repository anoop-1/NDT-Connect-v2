...
export const metadata: Metadata = {
  title: 'Weld Inspection Documentation',
  description: 'Requirements for weld inspection documentation and record retention.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-documentation' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Weld Inspection Documentation</span>
      </nav>

      <h1>Weld Inspection Documentation</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Requirements for weld inspection documentation and record retention.</p>
      ...
      <h2>Overview</h2>
      <p>Requirements for weld inspection documentation and record retention. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/services/visual-testing' target='_blank' rel='noopener'>Visual Testing Services</a>. Learn more about <a href='https://ndt-connect.com/certifications/api-653' target='_blank' rel='noopener'>API 653 Certification</a>. Learn more about <a href='https://ndt-connect.com/industries' target='_blank' rel='noopener'>NDT Industries</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding weld inspection documentation is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-automation' style={{ color: '#d97706' }}>&larr; Automated Weld Inspection</a>
        <a href='/weld-acceptance-criteria' style={{ color: '#d97706' }}>Weld Acceptance Criteria Comparison &rarr;</a>
      </div>
    </div>
  );
}
