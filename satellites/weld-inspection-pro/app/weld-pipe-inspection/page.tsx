...
export const metadata: Metadata = {
  title: 'Pipe Weld Inspection Guide',
  description: 'Inspection procedures for pipe welding including butt welds and branch connections.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-pipe-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Pipe Weld Inspection Guide</span>
      </nav>

      <h1>Pipe Weld Inspection Guide</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Inspection procedures for pipe welding including butt welds and branch connections.</p>
      ...
      <h2>Overview</h2>
      <p>Inspection procedures for pipe welding including butt welds and branch connections. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/services/acoustic-emission-testing' target='_blank' rel='noopener'>Acoustic Emission Testing</a>. Learn more about <a href='https://ndt-connect.com/services/guided-wave-testing' target='_blank' rel='noopener'>Guided Wave Testing</a>. Learn more about <a href='https://ndt-connect.com/industries/power-generation' target='_blank' rel='noopener'>Power Generation NDT</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding pipe weld inspection guide is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-stainless-steel' style={{ color: '#d97706' }}>&larr; Welding Stainless Steel Inspection</a>
        <a href='/weld-structural-inspection' style={{ color: '#d97706' }}>Structural Weld Inspection &rarr;</a>
      </div>
    </div>
  );
}
