...
export const metadata: Metadata = {
  title: 'Weld Inspection Career Guide',
  description: 'Career paths in welding inspection including CWI and CSWIP certification.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-inspection-careers' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Weld Inspection Career Guide</span>
      </nav>

      <h1>Weld Inspection Career Guide</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Career paths in welding inspection including CWI and CSWIP certification.</p>
      ...
      <h2>Overview</h2>
      <p>Career paths in welding inspection including CWI and CSWIP certification. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/industries' target='_blank' rel='noopener'>NDT Industries</a>. Learn more about <a href='https://ndt-connect.com/industries/manufacturing' target='_blank' rel='noopener'>Manufacturing NDT</a>. Learn more about <a href='https://ndt-connect.com/certifications' target='_blank' rel='noopener'>NDT Certifications</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding weld inspection career guide is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-welder-qualification' style={{ color: '#d97706' }}>&larr; Welder Performance Qualification</a>
        <span></span>
      </div>
    </div>
  );
