...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive guide to interpreting AWS welding symbols on engineering drawings.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-symbol-reading' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Reading Welding Symbols</span>
      </nav>

      <h1>Reading Welding Symbols</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to interpreting AWS welding symbols on engineering drawings.</p>
      ...
      <h2>Overview</h2>
      <p>Comprehensive guide to interpreting AWS welding symbols on engineering drawings. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/services/penetrant-testing' target='_blank' rel='noopener'>Penetrant Testing Services</a>. Learn more about <a href='https://ndt-connect.com/blog/corrosion-under-insulation-guide' target='_blank' rel='noopener'>CUI Guide</a>. Learn more about <a href='https://ndt-connect.com/faq' target='_blank' rel='noopener'>NDT FAQ</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding reading welding symbols is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-joint-design' style={{ color: '#d97706' }}>&larr; Weld Joint Design and Preparation</a>
        <a href='/weld-procedure-qualification' style={{ color: '#d97706' }}>WPS and PQR Development &rarr;</a>
      </div>
    </div>
  );
}
