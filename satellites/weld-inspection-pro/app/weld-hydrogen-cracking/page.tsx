...
export const metadata: Metadata = {
  title: 'Hydrogen Induced Cracking in Welds',
  description: 'Understanding and preventing hydrogen induced cracking in welds.',
  alternates: { canonical: 'https://weld-inspection-pro.vercel.app/weld-hydrogen-cracking' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Hydrogen Induced Cracking in Welds</span>
      </nav>

      <h1>Hydrogen Induced Cracking in Welds</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Understanding and preventing hydrogen induced cracking in welds.</p>
      ...
      <h2>Overview</h2>
      <p>Understanding and preventing hydrogen induced cracking in welds. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog/ndt-industry-statistics' target='_blank' rel='noopener'>NDT Industry Statistics</a>. Learn more about <a href='https://ndt-connect.com/services/corrosion-mapping' target='_blank' rel='noopener'>Corrosion Mapping Services</a>. Learn more about <a href='https://ndt-connect.com/services/visual-testing' target='_blank' rel='noopener'>Visual Testing Services</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding hydrogen induced cracking in welds is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/weld-process-selection' style={{ color: '#d97706' }}>&larr; Welding Process Selection</a>
        <a href='/weld-fatigue-assessment' style={{ color: '#d97706' }}>Weld Fatigue Life Assessment &rarr;</a>
      </div>
    </div>
  );
}
