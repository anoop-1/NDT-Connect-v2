...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive guide to crevice corrosion for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://corrosion-engineering-guide.vercel.app/corrosion-crevice' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Crevice Corrosion</span>
      </nav>

      <h1>Crevice Corrosion</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to crevice corrosion for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/corrosion-marine-environment' style={{ color: '#7c3aed' }}>&larr; Marine Corrosion</a>
        <a href='/corrosion-management-systems' style={{ color: '#7c3aed' }}>Corrosion Management Systems &rarr;</a>
      </div>
    </div>
  );
}
