...
export const metadata: Metadata = {
  title: 'Weld Corrosion',
  description: 'Comprehensive guide to weld corrosion for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://corrosion-engineering-guide.vercel.app/corrosion-weld-corrosion' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Weld Corrosion</span>
      </nav>

      <h1>Weld Corrosion</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to weld corrosion for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/corrosion-in-chemical-plants' style={{ color: '#7c3aed' }}>&larr; Chemical Plant Corrosion</a>
        <a href='/corrosion-testing-methods' style={{ color: '#7c3aed' }}>Corrosion Testing Methods &rarr;</a>
      </div>
    </div>
  );
}
