...
export default function Page() {
  return (
    <div>
      ...
      <h2>Overview</h2>
      <p>Comprehensive guide to hydrogen damage mechanisms for NDT professionals in industrial inspection and asset integrity management. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndtconnect.com/faq' target='_blank' rel='noopener'>NDT FAQ</a>. Learn more about <a href='https://ndtconnect.com/blog/ndt-industry-statistics' target='_blank' rel='noopener'>NDT Industry Statistics</a>. Learn more about <a href='https://ndtconnect.com/services/magnetic-flux-leakage' target='_blank' rel='noopener'>Magnetic Flux Leakage Testing</a>.</p>
