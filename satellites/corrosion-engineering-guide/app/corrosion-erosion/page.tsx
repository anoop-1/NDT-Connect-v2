...
export const metadata: Metadata = {
  title: 'Erosion-Corrosion',
  description: 'Comprehensive guide to erosion-corrosion for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://corrosion-engineering-guide.vercel.app/corrosion-erosion' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Erosion-Corrosion</span>
      </nav>

      <h1>Erosion-Corrosion</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to erosion-corrosion for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/corrosion-atmospheric' style={{ color: '#7c3aed' }}>&larr; Atmospheric Corrosion</a>
        <a href='/corrosion-hydrogen-damage' style={{ color: '#7c3aed' }}>Hydrogen Damage Mechanisms &rarr;</a>
      </div>
    </div>
  );
}
