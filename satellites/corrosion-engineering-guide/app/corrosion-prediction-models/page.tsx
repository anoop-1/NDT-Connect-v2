...
export const metadata: Metadata = {
  title: 'Corrosion Prediction Models',
  description: 'Comprehensive guide to corrosion prediction models for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://corrosion-engineering-guide.vercel.app/corrosion-prediction-models' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Corrosion Prediction Models</span>
      </nav>

      <h1>Corrosion Prediction Models</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to corrosion prediction models for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/corrosion-in-refineries' style={{ color: '#7c3aed' }}>&larr; Refinery Corrosion</a>
        <a href='/corrosion-standards-guide' style={{ color: '#7c3aed' }}>Corrosion Standards Guide &rarr;</a>
      </div>
    </div>
  );
}
