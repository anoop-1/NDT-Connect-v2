...
export const metadata: Metadata = {
  title: 'Corrosion Testing Methods',
  description: 'Comprehensive guide to corrosion testing methods for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://corrosion-engineering-guide.vercel.app/corrosion-testing-methods' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Corrosion Testing Methods</span>
      </nav>

      <h1>Corrosion Testing Methods</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to corrosion testing methods for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/corrosion-weld-corrosion' style={{ color: '#7c3aed' }}>&larr; Weld Corrosion</a>
        <a href='/corrosion-mapping-ut' style={{ color: '#7c3aed' }}>Corrosion Mapping with UT &rarr;</a>
      </div>
    </div>
  );
}
