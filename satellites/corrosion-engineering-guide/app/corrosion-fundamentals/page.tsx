...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive guide to corrosion fundamentals for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://corrosion-engineering-guide.vercel.app/corrosion-fundamentals' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Corrosion Fundamentals</span>
      </nav>

      <h1>Corrosion Fundamentals</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to corrosion fundamentals for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <h2>Overview</h2>
      <p>Comprehensive guide to corrosion fundamentals for NDT professionals in industrial inspection and asset integrity management. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/case-studies' target='_blank' rel='noopener'>NDT Case Studies</a>. Learn more about <a href='https://ndt-connect.com/blog/ndt-certifications-explained' target='_blank' rel='noopener'>NDT Certifications Explained</a>. Learn more about <a href='https://ndt-connect.com/blog/rbi-corrosion-management' target='_blank' rel='noopener'>RBI Corrosion Management</a>.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <span></span>
        <a href='/corrosion-types' style={{ color: '#7c3aed' }}>Types of Corrosion &rarr;</a>
      </div>
    </div>
  );
}
