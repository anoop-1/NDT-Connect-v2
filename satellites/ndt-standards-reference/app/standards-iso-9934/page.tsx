...
export const metadata: Metadata = {
  title: 'ISO 9934 Magnetic Testing',
  description: 'Comprehensive guide to iso 9934 magnetic testing for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-standards-reference.vercel.app/standards-iso-9934' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>ISO 9934 Magnetic Testing</span>
      </nav>

      <h1>ISO 9934 Magnetic Testing</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to iso 9934 magnetic testing for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/standards-iso-3452' style={{ color: '#0f766e' }}>&larr; ISO 3452 Penetrant Testing</a>
        <a href='/standards-en-13018' style={{ color: '#0f766e' }}>EN 13018 Visual Testing &rarr;</a>
      </div>
    </div>
  );
}
