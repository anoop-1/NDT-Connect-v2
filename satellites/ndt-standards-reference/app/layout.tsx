...
export const metadata: Metadata = {
  title: {
    default: 'NDT Standards Reference - Your Guide to NDT Codes and Standards',
    template: '%s | NDT Standards Reference',
  },
  description: 'Comprehensive reference for NDT codes, standards, and specifications from ASME, ASTM, AWS, ISO, EN, and API.',
  keywords: ['NDT', 'non-destructive testing', 'ndt standards reference', 'inspection'],
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang='en'>
      ...
      <body>
        <header style={{ borderBottom: '3px solid #0f766e', padding: '16px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <a href='/' style={{ fontWeight: 'bold', fontSize: '1.2rem', color: '#0f766e', textDecoration: 'none' }}>NDT Standards Reference</a>
          <nav style={{ display: 'flex', gap: '16px', fontSize: '0.9rem' }}>
            <a href='/' style={{ color: '#555', textDecoration: 'none' }}>Home</a>
            <a href='https://ndt-connect.com' target='_blank' rel='noopener' style={{ color: '#0f766e', textDecoration: 'none', fontWeight: 600 }}>NDT Connect</a>
          </nav>
        </header>
        ...
        <footer style={{ borderTop: '1px solid #e5e7eb', padding: '32px 24px', marginTop: '48px', textAlign: 'center', color: '#888', fontSize: '0.85rem' }}>
          <p>&copy; 2026 NDT Standards Reference. An educational resource by <a href='https://ndt-connect.com' target='_blank' rel='noopener' style={{ color: '#0f766e' }}>NDT Connect</a>.</p>
