...
export const metadata: Metadata = {
  title: 'ISO 3452 Penetrant Testing',
  description: 'Comprehensive guide to iso 3452 penetrant testing for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-standards-reference.vercel.app/standards-iso-3452' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>ISO 3452 Penetrant Testing</span>
      </nav>

      <h1>ISO 3452 Penetrant Testing</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to iso 3452 penetrant testing for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/standards-iso-17640' style={{ color: '#0f766e' }}>&larr; ISO 17640 Ultrasonic Testing</a>
        <a href='/standards-iso-9934' style={{ color: '#0f766e' }}>ISO 9934 Magnetic Testing &rarr;</a>
      </div>
    </div>
  );
}
