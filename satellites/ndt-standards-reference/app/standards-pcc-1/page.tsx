...
export const metadata: Metadata = {
  title: 'API PCC-1 Guidelines',
  description: 'Comprehensive guide to api pcc-1 guidelines for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-standards-reference.vercel.app/standards-pcc-1' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>API PCC-1 Guidelines</span>
      </nav>

      <h1>API PCC-1 Guidelines</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to api pcc-1 guidelines for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/standards-nadcap-ac7114' style={{ color: '#0f766e' }}>&larr; Nadcap AC7114 NDT</a>
        <a href='/standards-comparison-guide' style={{ color: '#0f766e' }}>Standards Comparison Guide &rarr;</a>
      </div>
    </div>
  );
}
