...
export const metadata: Metadata = {
  title: 'API PCC-2 Repairs',
  description: 'Comprehensive guide to api pcc-2 repairs for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-standards-reference.vercel.app/standards-pcc-2' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>API PCC-2 Repairs</span>
      </nav>

      <h1>API PCC-2 Repairs</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to api pcc-2 repairs for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/standards-dnv-rules' style={{ color: '#0f766e' }}>&larr; DNV Rules for NDT</a>
        <a href='/standards-api-1104' style={{ color: '#0f766e' }}>API 1104 Pipeline Welding &rarr;</a>
      </div>
    </div>
  );
}
