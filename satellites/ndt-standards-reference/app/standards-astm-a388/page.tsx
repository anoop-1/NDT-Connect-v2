...
export const metadata: Metadata = {
  title: 'ASTM A388 UT of Forgings',
  description: 'Comprehensive guide to astm a388 ut of forgings for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-standards-reference.vercel.app/standards-astm-a388' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>ASTM A388 UT of Forgings</span>
      </nav>

      <h1>ASTM A388 UT of Forgings</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to astm a388 ut of forgings for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/standards-astm-e1444' style={{ color: '#0f766e' }}>&larr; ASTM E1444 Magnetic Testing</a>
        <a href='/standards-astm-e1932' style={{ color: '#0f766e' }}>ASTM E1932 Acoustic Emission &rarr;</a>
      </div>
    </div>
  );
}
