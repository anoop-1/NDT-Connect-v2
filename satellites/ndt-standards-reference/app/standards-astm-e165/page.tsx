...
export const metadata: Metadata = {
  title: 'ASTM E165 Penetrant Testing',
  description: 'Comprehensive guide to astm e165 penetrant testing for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-standards-reference.vercel.app/standards-astm-e165' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>ASTM E165 Penetrant Testing</span>
      </nav>

      <h1>ASTM E165 Penetrant Testing</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to astm e165 penetrant testing for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/standards-en-13018' style={{ color: '#0f766e' }}>&larr; EN 13018 Visual Testing</a>
        <a href='/standards-astm-e709' style={{ color: '#0f766e' }}>ASTM E709 Magnetic Testing &rarr;</a>
      </div>
    </div>
  );
}
