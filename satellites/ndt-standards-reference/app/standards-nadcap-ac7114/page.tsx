...
export const metadata: Metadata = {
  title: 'Nadcap AC7114 NDT',
  description: 'Comprehensive guide to nadcap ac7114 ndt for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-standards-reference.vercel.app/standards-nadcap-ac7114' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Nadcap AC7114 NDT</span>
      </nav>

      <h1>Nadcap AC7114 NDT</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to nadcap ac7114 ndt for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/standards-cswip' style={{ color: '#0f766e' }}>&larr; CSWIP Welding Inspection</a>
        <a href='/standards-pcc-1' style={{ color: '#0f766e' }}>API PCC-1 Guidelines &rarr;</a>
      </div>
    </div>
  );
}
