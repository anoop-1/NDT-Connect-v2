...
export const metadata: Metadata = {
  title: 'ASME Section V Overview',
  description: 'Comprehensive guide to asme section v overview for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-standards-reference.vercel.app/standards-asme-section-v' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>ASME Section V Overview</span>
      </nav>

      <h1>ASME Section V Overview</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to asme section v overview for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <span></span>
        <a href='/standards-asme-section-viii' style={{ color: '#0f766e' }}>ASME Section VIII NDE &rarr;</a>
      </div>
    </div>
  );
}
