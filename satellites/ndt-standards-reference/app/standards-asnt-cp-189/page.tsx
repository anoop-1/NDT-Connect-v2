...
export const metadata: Metadata = {
  title: 'ASNT CP-189 Standard',
  description: 'Comprehensive guide to asnt cp-189 standard for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-standards-reference.vercel.app/standards-asnt-cp-189' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>ASNT CP-189 Standard</span>
      </nav>

      <h1>ASNT CP-189 Standard</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to asnt cp-189 standard for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/standards-asnt-snt-tc-1a' style={{ color: '#0f766e' }}>&larr; ASNT SNT-TC-1A Overview</a>
        <a href='/standards-norsok' style={{ color: '#0f766e' }}>NORSOK NDT Standards &rarr;</a>
      </div>
    </div>
  );
}
