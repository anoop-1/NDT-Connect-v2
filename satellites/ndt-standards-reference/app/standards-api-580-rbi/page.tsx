...
export const metadata: Metadata = {
  title: 'API 580/581 RBI',
  description: 'Comprehensive guide to api 580/581 rbi for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-standards-reference.vercel.app/standards-api-580-rbi' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>API 580/581 RBI</span>
      </nav>

      <h1>API 580/581 RBI</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to api 580/581 rbi for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/standards-api-579' style={{ color: '#0f766e' }}>&larr; API 579 Fitness-for-Service</a>
        <a href='/standards-iso-9712' style={{ color: '#0f766e' }}>ISO 9712 Qualification &rarr;</a>
      </div>
    </div>
  );
}
