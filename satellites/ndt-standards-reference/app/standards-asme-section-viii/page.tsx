...
export const metadata: Metadata = {
  title: 'ASME Section VIII NDE',
  description: 'Comprehensive guide to asme section viii nde for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-standards-reference.vercel.app/standards-asme-section-viii' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>ASME Section VIII NDE</span>
      </nav>

      <h1>ASME Section VIII NDE</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to asme section viii nde for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/standards-asme-section-v' style={{ color: '#0f766e' }}>&larr; ASME Section V Overview</a>
        <a href='/standards-aws-d1-1' style={{ color: '#0f766e' }}>AWS D1.1 NDE Requirements &rarr;</a>
      </div>
    </div>
  );
}
