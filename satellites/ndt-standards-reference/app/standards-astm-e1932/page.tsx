...
export const metadata: Metadata = {
  title: 'ASTM E1932 Acoustic Emission',
  description: 'Comprehensive guide to astm e1932 acoustic emission for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-standards-reference.vercel.app/standards-astm-e1932' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>ASTM E1932 Acoustic Emission</span>
      </nav>

      <h1>ASTM E1932 Acoustic Emission</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to astm e1932 acoustic emission for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/standards-astm-a388' style={{ color: '#0f766e' }}>&larr; ASTM A388 UT of Forgings</a>
        <a href='/standards-pcn-scheme' style={{ color: '#0f766e' }}>PCN Certification Scheme &rarr;</a>
      </div>
    </div>
  );
}
