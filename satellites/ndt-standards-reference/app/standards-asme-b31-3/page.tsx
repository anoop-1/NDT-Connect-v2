...
export const metadata: Metadata = {
  title: 'ASME B31.3 NDE',
  description: 'Comprehensive guide to asme b31.3 nde for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-standards-reference.vercel.app/standards-asme-b31-3' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>ASME B31.3 NDE</span>
      </nav>

      <h1>ASME B31.3 NDE</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to asme b31.3 nde for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/standards-api-1104' style={{ color: '#0f766e' }}>&larr; API 1104 Pipeline Welding</a>
        <a href='/standards-asme-b31-4' style={{ color: '#0f766e' }}>ASME B31.4 NDE &rarr;</a>
      </div>
    </div>
  );
}
