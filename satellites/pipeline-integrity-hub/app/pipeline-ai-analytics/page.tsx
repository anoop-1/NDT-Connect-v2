...
export const metadata: Metadata = {
  title: 'AI in Pipeline Integrity',
  description: 'Comprehensive guide to ai in pipeline integrity for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://pipeline-integrity-hub.vercel.app/pipeline-ai-analytics' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>AI in Pipeline Integrity</span>
      </nav>

      <h1>AI in Pipeline Integrity</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to ai in pipeline integrity for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/pipeline-robotic-inspection' style={{ color: '#059669' }}>&larr; Robotic Pipeline Inspection</a>
        <a href='/pipeline-career-guide' style={{ color: '#059669' }}>Pipeline Career Guide &rarr;</a>
      </div>
    </div>
  );
}
