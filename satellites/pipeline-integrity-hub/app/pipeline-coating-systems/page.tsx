...
export const metadata: Metadata = {
  title: 'Pipeline Coating Systems',
  description: 'Comprehensive guide to pipeline coating systems for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://pipeline-integrity-hub.vercel.app/pipeline-coating-systems' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Pipeline Coating Systems</span>
      </nav>

      <h1>Pipeline Coating Systems</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to pipeline coating systems for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/pipeline-cathodic-protection' style={{ color: '#059669' }}>&larr; Pipeline Cathodic Protection</a>
        <a href='/pipeline-girth-weld-inspection' style={{ color: '#059669' }}>Girth Weld Inspection &rarr;</a>
      </div>
    </div>
  );
}
