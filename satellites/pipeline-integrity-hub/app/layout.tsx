...
export const metadata: Metadata = {
  title: {
    default: 'Pipeline Integrity Hub - Pipeline Inspection and Integrity Management',
    template: '%s | Pipeline Integrity Hub',
  },
  ...
  keywords: ['NDT', 'non-destructive testing', 'pipeline integrity hub', 'inspection'],
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang='en'>
      ...
      <body>
        <header style={{ borderBottom: '3px solid #059669', padding: '16px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
