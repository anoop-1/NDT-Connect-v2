...
export const metadata: Metadata = {
  title: 'Class Location Changes',
  description: 'Comprehensive guide to class location changes for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://pipeline-integrity-hub.vercel.app/pipeline-class-location' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Class Location Changes</span>
      </nav>

      <h1>Class Location Changes</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to class location changes for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/pipeline-third-party-damage' style={{ color: '#059669' }}>&larr; Third Party Damage Prevention</a>
        <a href='/pipeline-digital-twins' style={{ color: '#059669' }}>Pipeline Digital Twins &rarr;</a>
      </div>
    </div>
  );
}
