...
export const metadata: Metadata = {
  title: 'MFL Pipeline Inspection',
  description: 'Comprehensive guide to mfl pipeline inspection for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://pipeline-integrity-hub.vercel.app/pipeline-mfl-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>MFL Pipeline Inspection</span>
      </nav>

      <h1>MFL Pipeline Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to mfl pipeline inspection for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/pipeline-pigging-operations' style={{ color: '#059669' }}>&larr; Pigging Operations Guide</a>
        <a href='/pipeline-ut-inspection' style={{ color: '#059669' }}>UT Pipeline Inspection &rarr;</a>
      </div>
    </div>
  );
}
