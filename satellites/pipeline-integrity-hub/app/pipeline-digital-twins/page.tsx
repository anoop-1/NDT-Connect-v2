...
export const metadata: Metadata = {
  title: 'Pipeline Digital Twins',
  description: 'Comprehensive guide to pipeline digital twins for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://pipeline-integrity-hub.vercel.app/pipeline-digital-twins' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Pipeline Digital Twins</span>
      </nav>

      <h1>Pipeline Digital Twins</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to pipeline digital twins for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/pipeline-class-location' style={{ color: '#059669' }}>&larr; Class Location Changes</a>
        <a href='/pipeline-robotic-inspection' style={{ color: '#059669' }}>Robotic Pipeline Inspection &rarr;</a>
      </div>
    </div>
  );
}
