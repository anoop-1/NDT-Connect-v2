...
export const metadata: Metadata = {
  title: 'Seam Weld Assessment',
  description: 'Comprehensive guide to seam weld assessment for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://pipeline-integrity-hub.vercel.app/pipeline-seam-weld-assessment' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Seam Weld Assessment</span>
      </nav>

      <h1>Seam Weld Assessment</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to seam weld assessment for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/pipeline-offshore-inspection' style={{ color: '#059669' }}>&larr; Offshore Pipeline Inspection</a>
        <a href='/pipeline-third-party-damage' style={{ color: '#059669' }}>Third Party Damage Prevention &rarr;</a>
      </div>
    </div>
  );
}
