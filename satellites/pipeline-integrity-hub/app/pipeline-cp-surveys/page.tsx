...
export const metadata: Metadata = {
  title: 'CP Survey Methods',
  description: 'Comprehensive guide to cp survey methods for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://pipeline-integrity-hub.vercel.app/pipeline-cp-surveys' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>CP Survey Methods</span>
      </nav>

      <h1>CP Survey Methods</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to cp survey methods for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/pipeline-scc-management' style={{ color: '#059669' }}>&larr; SCC Management</a>
        <a href='/pipeline-anomaly-assessment' style={{ color: '#059669' }}>Anomaly Assessment &rarr;</a>
      </div>
    </div>
  );
}
