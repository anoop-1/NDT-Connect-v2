...
export const metadata: Metadata = {
  title: 'RT Film Viewers',
  description: 'Comprehensive guide to rt film viewers for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-equipment-reviews.vercel.app/equipment-film-viewers' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>RT Film Viewers</span>
      </nav>

      <h1>RT Film Viewers</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to rt film viewers for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/equipment-uv-lighting' style={{ color: '#6366f1' }}>&larr; NDT UV Lighting</a>
        <a href='/equipment-dosimeters' style={{ color: '#6366f1' }}>Personal Dosimeters &rarr;</a>
      </div>
    </div>
  );
}
