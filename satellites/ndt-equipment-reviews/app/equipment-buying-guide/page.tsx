...
export const metadata: Metadata = {
  title: 'NDT Buying Guide',
  description: 'Comprehensive guide to ndt buying guide for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-equipment-reviews.vercel.app/equipment-buying-guide' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>NDT Buying Guide</span>
      </nav>

      <h1>NDT Buying Guide</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to ndt buying guide for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/equipment-dosimeters' style={{ color: '#6366f1' }}>&larr; Personal Dosimeters</a>
        <a href='/equipment-equipment-trends' style={{ color: '#6366f1' }}>Equipment Trends 2026 &rarr;</a>
      </div>
    </div>
  );
}
