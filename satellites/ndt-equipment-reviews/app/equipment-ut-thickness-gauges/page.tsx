...
export const metadata: Metadata = {
  title: 'UT Thickness Gauges',
  description: 'Comprehensive guide to ut thickness gauges for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-equipment-reviews.vercel.app/equipment-ut-thickness-gauges' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>UT Thickness Gauges</span>
      </nav>

      <h1>UT Thickness Gauges</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to ut thickness gauges for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/equipment-phased-array-units' style={{ color: '#6366f1' }}>&larr; Phased Array UT Equipment</a>
        <a href='/equipment-x-ray-generators' style={{ color: '#6366f1' }}>X-Ray Generators for NDT &rarr;</a>
      </div>
    </div>
  );
}
