...
export const metadata: Metadata = {
  title: 'PMI Analyzers Compared',
  description: 'Comprehensive guide to pmi analyzers compared for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-equipment-reviews.vercel.app/equipment-pmi-analyzers' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>PMI Analyzers Compared</span>
      </nav>

      <h1>PMI Analyzers Compared</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to pmi analyzers compared for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/equipment-thermal-cameras' style={{ color: '#6366f1' }}>&larr; Thermal Cameras for NDT</a>
        <a href='/equipment-weld-gauges' style={{ color: '#6366f1' }}>Weld Inspection Gauges &rarr;</a>
      </div>
    </div>
  );
}
