...
export const metadata: Metadata = {
  title: 'Borescopes and Videoscopes',
  description: 'Comprehensive guide to borescopes and videoscopes for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-equipment-reviews.vercel.app/equipment-borescopes' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Borescopes and Videoscopes</span>
      </nav>

      <h1>Borescopes and Videoscopes</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to borescopes and videoscopes for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/equipment-hardness-testers' style={{ color: '#6366f1' }}>&larr; Portable Hardness Testers</a>
        <a href='/equipment-ndt-drones' style={{ color: '#6366f1' }}>NDT Inspection Drones &rarr;</a>
      </div>
    </div>
  );
}
