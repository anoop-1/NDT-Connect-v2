...
export const metadata: Metadata = {
  title: 'Equipment Trends 2026',
  description: 'Comprehensive guide to equipment trends 2026 for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-equipment-reviews.vercel.app/equipment-equipment-trends' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Equipment Trends 2026</span>
      </nav>

      <h1>Equipment Trends 2026</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to equipment trends 2026 for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/equipment-buying-guide' style={{ color: '#6366f1' }}>&larr; NDT Buying Guide</a>
        <span></span>
      </div>
    </div>
  );
