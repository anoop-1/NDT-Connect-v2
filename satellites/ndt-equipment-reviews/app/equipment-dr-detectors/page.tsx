...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive guide to digital radiography systems for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-equipment-reviews.vercel.app/equipment-dr-detectors' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Digital Radiography Systems</span>
      </nav>

      <h1>Digital Radiography Systems</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to digital radiography systems for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/equipment-gamma-sources' style={{ color: '#6366f1' }}>&larr; Gamma Ray Source Guide</a>
        <a href='/equipment-mt-equipment' style={{ color: '#6366f1' }}>MT Equipment Guide &rarr;</a>
      </div>
    </div>
  );
}
