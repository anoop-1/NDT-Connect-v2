...
export const metadata: Metadata = {
  title: 'NDT Data Loggers',
  description: 'Comprehensive guide to ndt data loggers for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-equipment-reviews.vercel.app/equipment-data-loggers' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>NDT Data Loggers</span>
      </nav>

      <h1>NDT Data Loggers</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to ndt data loggers for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/equipment-tofd-equipment' style={{ color: '#6366f1' }}>&larr; TOFD Testing Equipment</a>
        <a href='/equipment-mfl-equipment' style={{ color: '#6366f1' }}>MFL Inspection Equipment &rarr;</a>
      </div>
    </div>
  );
}
