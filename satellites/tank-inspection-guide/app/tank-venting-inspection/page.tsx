...
export const metadata: Metadata = {
  title: 'Venting System Inspection',
  description: 'Comprehensive guide to venting system inspection for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://tank-inspection-guide.vercel.app/tank-venting-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Venting System Inspection</span>
      </nav>

      <h1>Venting System Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to venting system inspection for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/tank-floating-roof' style={{ color: '#0d9488' }}>&larr; Floating Roof Inspection</a>
        <a href='/tank-appurtenance-inspection' style={{ color: '#0d9488' }}>Appurtenance Inspection &rarr;</a>
      </div>
    </div>
  );
}
