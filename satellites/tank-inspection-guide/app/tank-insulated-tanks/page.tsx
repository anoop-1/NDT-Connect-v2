...
export const metadata: Metadata = {
  title: 'Insulated Tank Inspection',
  description: 'Comprehensive guide to insulated tank inspection for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://tank-inspection-guide.vercel.app/tank-insulated-tanks' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Insulated Tank Inspection</span>
      </nav>

      <h1>Insulated Tank Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to insulated tank inspection for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/tank-appurtenance-inspection' style={{ color: '#0d9488' }}>&larr; Appurtenance Inspection</a>
        <a href='/tank-hot-product' style={{ color: '#0d9488' }}>Hot Product Tanks &rarr;</a>
      </div>
    </div>
  );
}
