...
export const metadata: Metadata = {
  title: 'Tank Cathodic Protection',
  description: 'Comprehensive guide to tank cathodic protection for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://tank-inspection-guide.vercel.app/tank-cathodic-protection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Tank Cathodic Protection</span>
      </nav>

      <h1>Tank Cathodic Protection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to tank cathodic protection for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/tank-bottom-corrosion' style={{ color: '#0d9488' }}>&larr; Tank Bottom Corrosion</a>
        <a href='/tank-secondary-containment' style={{ color: '#0d9488' }}>Secondary Containment &rarr;</a>
      </div>
    </div>
  );
}
