...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://tank-inspection-guide.vercel.app/tank-rbi' },
};
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/tank-regulatory-requirements' style={{ color: '#0d9488' }}>&larr; Regulatory Requirements</a>
        <a href='/tank-decommissioning' style={{ color: '#0d9488' }}>Tank Decommissioning &rarr;</a>
      </div>
    </div>
  );
}
