...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive guide to vacuum box testing for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://tank-inspection-guide.vercel.app/tank-vacuum-box-testing' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Vacuum Box Testing</span>
      </nav>

      <h1>Vacuum Box Testing</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to vacuum box testing for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/tank-coating-inspection' style={{ color: '#0d9488' }}>&larr; Tank Coating Inspection</a>
        <a href='/tank-acoustic-emission' style={{ color: '#0d9488' }}>AE Testing for Tanks &rarr;</a>
      </div>
    </div>
  );
}
