...
export const metadata: Metadata = {
  title: 'Tank Corrosion Assessment',
  description: 'Comprehensive guide to tank corrosion assessment for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://tank-inspection-guide.vercel.app/tank-corrosion-assessment' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Tank Corrosion Assessment</span>
      </nav>

      <h1>Tank Corrosion Assessment</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to tank corrosion assessment for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/tank-foundation-assessment' style={{ color: '#0d9488' }}>&larr; Tank Foundation Assessment</a>
        <a href='/tank-weld-inspection' style={{ color: '#0d9488' }}>Tank Weld Inspection &rarr;</a>
      </div>
    </div>
  );
}
