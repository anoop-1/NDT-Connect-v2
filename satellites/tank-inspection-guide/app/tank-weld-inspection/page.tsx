...
export const metadata: Metadata = {
  title: 'Tank Weld Inspection',
  description: 'Comprehensive guide to tank weld inspection for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://tank-inspection-guide.vercel.app/tank-weld-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Tank Weld Inspection</span>
      </nav>

      <h1>Tank Weld Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to tank weld inspection for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/tank-corrosion-assessment' style={{ color: '#0d9488' }}>&larr; Tank Corrosion Assessment</a>
        <a href='/tank-fitness-for-service' style={{ color: '#0d9488' }}>Tank Fitness-for-Service &rarr;</a>
      </div>
    </div>
  );
}
