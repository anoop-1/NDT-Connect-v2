...
export const metadata: Metadata = {
  title: 'UT Corrosion Detection Methods',
  description: 'Using ultrasonic testing for corrosion detection, mapping, and monitoring in industrial facilities and infrastructure.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-for-corrosion' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>UT Corrosion Detection Methods</span>
      </nav>

      <h1>UT Corrosion Detection Methods</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Using ultrasonic testing for corrosion detection, mapping, and monitoring in industrial facilities and infrastructure.</p>
      ...
      <h2>Overview</h2>
      <p>Using ultrasonic testing for corrosion detection, mapping, and monitoring in industrial facilities and infrastructure. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/industries/power-generation' target='_blank' rel='noopener'>Power Generation NDT</a>. Learn more about <a href='https://ndt-connect.com/blog/corrosion-under-insulation-guide' target='_blank' rel='noopener'>CUI Guide</a>. Learn more about <a href='https://ndt-connect.com/certifications/api-653' target='_blank' rel='noopener'>API 653 Certification</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding ut corrosion detection methods is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-codes-standards' style={{ color: '#1e40af' }}>&larr; UT Codes and Standards Reference</a>
        <a href='/ut-for-pipelines' style={{ color: '#1e40af' }}>UT Pipeline Inspection Methods &rarr;</a>
      </div>
    </div>
  );
}
