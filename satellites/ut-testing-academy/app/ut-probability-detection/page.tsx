...
export default function Page() {
  return (
    <div>
      ...
      <h2>Overview</h2>
      <p>Understanding probability of detection in ultrasonic testing and factors affecting inspection reliability. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndtconnect.com/certifications' target='_blank' rel='noopener'>NDT Certifications</a>. Learn more about <a href='https://ndtconnect.com/blog/ndt-digital-twins-guide' target='_blank' rel='noopener'>NDT Digital Twins</a>. Learn more about <a href='https://ndtconnect.com/certifications/api-653' target='_blank' rel='noopener'>API 653 Certification</a>.</p>
