...
export const metadata: Metadata = {
  title: 'UT Weld Inspection Techniques',
  description: 'Detailed methods for ultrasonic weld inspection covering joint preparation scanning, angle beam techniques, and acceptance criteria per AWS D1.1.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-weld-inspection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>UT Weld Inspection Techniques</span>
      </nav>

      <h1>UT Weld Inspection Techniques</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Detailed methods for ultrasonic weld inspection covering joint preparation scanning, angle beam techniques, and acceptance criteria per AWS D1.1.</p>
      ...
      <h2>Overview</h2>
      <p>Detailed methods for ultrasonic weld inspection covering joint preparation scanning, angle beam techniques, and acceptance criteria per AWS D1.1. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/certifications/pcn-certification' target='_blank' rel='noopener'>PCN Certification</a>. Learn more about <a href='https://ndt-connect.com/blog/corrosion-under-insulation-guide' target='_blank' rel='noopener'>CUI Guide</a>. Learn more about <a href='https://ndt-connect.com/blog' target='_blank' rel='noopener'>NDT Blog</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding ut weld inspection techniques is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-equipment-guide' style={{ color: '#1e40af' }}>&larr; UT Equipment Selection Guide</a>
        <a href='/ut-thickness-measurement' style={{ color: '#1e40af' }}>Wall Thickness Measurement with UT &rarr;</a>
      </div>
    </div>
  );
}
