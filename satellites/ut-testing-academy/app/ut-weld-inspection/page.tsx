...
export default function Page() {
  return (
    <div>
      ...
      <h2>Overview</h2>
      <p>Detailed methods for ultrasonic weld inspection covering joint preparation scanning, angle beam techniques, and acceptance criteria per AWS D1.1. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndtconnect.com/certifications/pcn-certification' target='_blank' rel='noopener'>PCN Certification</a>. Learn more about <a href='https://ndtconnect.com/blog/corrosion-under-insulation-guide' target='_blank' rel='noopener'>CUI Guide</a>. Learn more about <a href='https://ndtconnect.com/blog' target='_blank' rel='noopener'>NDT Blog</a>.</p>
