...
export const metadata: Metadata = {
  title: 'UT for Storage Tank Inspection',
  description: 'Ultrasonic testing procedures for above-ground storage tank floors, shells, and roofs per API 653.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-for-storage-tanks' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>UT for Storage Tank Inspection</span>
      </nav>

      <h1>UT for Storage Tank Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Ultrasonic testing procedures for above-ground storage tank floors, shells, and roofs per API 653.</p>
      ...
      <h2>Overview</h2>
      <p>Ultrasonic testing procedures for above-ground storage tank floors, shells, and roofs per API 653. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/tools/ndt-method-selector' target='_blank' rel='noopener'>NDT Method Selector Tool</a>. Learn more about <a href='https://ndt-connect.com/industries/marine-and-offshore' target='_blank' rel='noopener'>Marine & Offshore NDT</a>. Learn more about <a href='https://ndt-connect.com/certifications/api-653' target='_blank' rel='noopener'>API 653 Certification</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding ut for storage tank inspection is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-guided-waves' style={{ color: '#1e40af' }}>&larr; Guided Wave UT Explained</a>
        <a href='/ut-flaw-sizing' style={{ color: '#1e40af' }}>UT Flaw Sizing Techniques &rarr;</a>
      </div>
    </div>
  );
}
