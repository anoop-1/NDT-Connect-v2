...
export default function Page() {
  return (
    <div>
      ...
      <h2>Overview</h2>
      <p>Specialized UT techniques for composite material inspection including through-transmission, pulse-echo, and bond testing. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndtconnect.com/tools/inspection-cost-estimator' target='_blank' rel='noopener'>NDT Cost Estimator</a>. Learn more about <a href='https://ndtconnect.com' target='_blank' rel='noopener'>NDT Connect</a>. Learn more about <a href='https://ndtconnect.com/contact' target='_blank' rel='noopener'>Contact NDT Connect</a>.</p>
