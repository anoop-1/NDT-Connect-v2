...
export const metadata: Metadata = {
  title: 'Ultrasonic Testing of Composites',
  description: 'Specialized UT techniques for composite material inspection including through-transmission, pulse-echo, and bond testing.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-for-composites' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Ultrasonic Testing of Composites</span>
      </nav>

      <h1>Ultrasonic Testing of Composites</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Specialized UT techniques for composite material inspection including through-transmission, pulse-echo, and bond testing.</p>
      ...
      <h2>Overview</h2>
      <p>Specialized UT techniques for composite material inspection including through-transmission, pulse-echo, and bond testing. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/tools/inspection-cost-estimator' target='_blank' rel='noopener'>NDT Cost Estimator</a>. Learn more about <a href='https://ndt-connect.com' target='_blank' rel='noopener'>NDT Connect</a>. Learn more about <a href='https://ndt-connect.com/contact' target='_blank' rel='noopener'>Contact NDT Connect</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding ultrasonic testing of composites is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/contact-ut-vs-immersion' style={{ color: '#1e40af' }}>&larr; Contact UT vs Immersion Testing</a>
        <a href='/ut-data-recording' style={{ color: '#1e40af' }}>UT Data Recording and Reporting &rarr;</a>
      </div>
    </div>
  );
}
