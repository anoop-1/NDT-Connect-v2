...
export const metadata: Metadata = {
  title: 'UT Couplant Selection and Use',
  description: 'Understanding ultrasonic couplants, their properties, selection criteria for different testing scenarios.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-couplant-selection' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>UT Couplant Selection and Use</span>
      </nav>

      <h1>UT Couplant Selection and Use</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Understanding ultrasonic couplants, their properties, selection criteria for different testing scenarios.</p>
      ...
      <h2>Overview</h2>
      <p>Understanding ultrasonic couplants, their properties, selection criteria for different testing scenarios. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/services/corrosion-mapping' target='_blank' rel='noopener'>Corrosion Mapping Services</a>. Learn more about <a href='https://ndt-connect.com/industries/aerospace' target='_blank' rel='noopener'>Aerospace NDT</a>. Learn more about <a href='https://ndt-connect.com/certifications/api-570' target='_blank' rel='noopener'>API 570 Certification</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding ut couplant selection and use is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-transducer-guide' style={{ color: '#1e40af' }}>&larr; UT Transducer Selection Guide</a>
        <a href='/ut-codes-standards' style={{ color: '#1e40af' }}>UT Codes and Standards Reference &rarr;</a>
      </div>
    </div>
  );
}
