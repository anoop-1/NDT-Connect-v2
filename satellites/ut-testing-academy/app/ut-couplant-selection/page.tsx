...
export default function Page() {
  return (
    <div>
      ...
      <h2>Overview</h2>
      <p>Understanding ultrasonic couplants, their properties, selection criteria for different testing scenarios. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndtconnect.com/services/corrosion-mapping' target='_blank' rel='noopener'>Corrosion Mapping Services</a>. Learn more about <a href='https://ndtconnect.com/industries/aerospace' target='_blank' rel='noopener'>Aerospace NDT</a>. Learn more about <a href='https://ndtconnect.com/certifications/api-570' target='_blank' rel='noopener'>API 570 Certification</a>.</p>
