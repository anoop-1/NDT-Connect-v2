...
export const metadata: Metadata = {
  title: 'UT in Aerospace Applications',
  description: 'Aerospace-specific ultrasonic testing requirements, methods, and standards for aircraft structural inspection.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-for-aerospace' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>UT in Aerospace Applications</span>
      </nav>

      <h1>UT in Aerospace Applications</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Aerospace-specific ultrasonic testing requirements, methods, and standards for aircraft structural inspection.</p>
      ...
      <h2>Overview</h2>
      <p>Aerospace-specific ultrasonic testing requirements, methods, and standards for aircraft structural inspection. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/certifications/asnt-certification' target='_blank' rel='noopener'>ASNT Certification</a>. Learn more about <a href='https://ndt-connect.com/services/guided-wave-testing' target='_blank' rel='noopener'>Guided Wave Testing</a>. Learn more about <a href='https://ndt-connect.com/services/tofd-testing' target='_blank' rel='noopener'>TOFD Testing Services</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding ut in aerospace applications is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-probability-detection' style={{ color: '#1e40af' }}>&larr; UT Probability of Detection</a>
        <a href='/ut-guided-waves' style={{ color: '#1e40af' }}>Guided Wave UT Explained &rarr;</a>
      </div>
    </div>
  );
}
