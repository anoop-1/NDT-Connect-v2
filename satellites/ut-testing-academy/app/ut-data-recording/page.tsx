...
export const metadata: Metadata = {
  title: 'UT Data Recording and Reporting',
  description: 'Best practices for ultrasonic testing data recording, documentation requirements, and generating compliant inspection reports.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-data-recording' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>UT Data Recording and Reporting</span>
      </nav>

      <h1>UT Data Recording and Reporting</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Best practices for ultrasonic testing data recording, documentation requirements, and generating compliant inspection reports.</p>
      ...
      <h2>Overview</h2>
      <p>Best practices for ultrasonic testing data recording, documentation requirements, and generating compliant inspection reports. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/certifications/asnt-certification' target='_blank' rel='noopener'>ASNT Certification</a>. Learn more about <a href='https://ndt-connect.com/faq' target='_blank' rel='noopener'>NDT FAQ</a>. Learn more about <a href='https://ndt-connect.com/services/tofd-testing' target='_blank' rel='noopener'>TOFD Testing Services</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding ut data recording and reporting is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-for-composites' style={{ color: '#1e40af' }}>&larr; Ultrasonic Testing of Composites</a>
        <a href='/ut-for-forgings' style={{ color: '#1e40af' }}>UT Inspection of Forgings &rarr;</a>
      </div>
    </div>
  );
}
