...
export const metadata: Metadata = {
  title: 'UT Calibration Procedures',
  description: 'Step-by-step calibration procedures for ultrasonic testing equipment including DAC curves, TCG, and reference standards.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-calibration-procedures' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>UT Calibration Procedures</span>
      </nav>

      <h1>UT Calibration Procedures</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Step-by-step calibration procedures for ultrasonic testing equipment including DAC curves, TCG, and reference standards.</p>
      ...
      <h2>Overview</h2>
      <p>Step-by-step calibration procedures for ultrasonic testing equipment including DAC curves, TCG, and reference standards. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/tools/ndt-method-selector' target='_blank' rel='noopener'>NDT Method Selector Tool</a>. Learn more about <a href='https://ndt-connect.com/blog/rbi-corrosion-management' target='_blank' rel='noopener'>RBI Corrosion Management</a>. Learn more about <a href='https://ndt-connect.com/industries/mining' target='_blank' rel='noopener'>Mining NDT</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding ut calibration procedures is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-thickness-measurement' style={{ color: '#1e40af' }}>&larr; Wall Thickness Measurement with UT</a>
        <a href='/contact-ut-vs-immersion' style={{ color: '#1e40af' }}>Contact UT vs Immersion Testing &rarr;</a>
      </div>
    </div>
  );
}
