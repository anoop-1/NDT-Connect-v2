...
export const metadata: Metadata = {
  title: 'Advanced UT Techniques Overview',
  description: 'Overview of advanced ultrasonic methods including TOFD, phased array, full matrix capture, and total focusing method.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/advanced-ut-techniques' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Advanced UT Techniques Overview</span>
      </nav>

      <h1>Advanced UT Techniques Overview</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Overview of advanced ultrasonic methods including TOFD, phased array, full matrix capture, and total focusing method.</p>
      ...
      <h2>Overview</h2>
      <p>Overview of advanced ultrasonic methods including TOFD, phased array, full matrix capture, and total focusing method. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog/weld-inspection-complete-guide' target='_blank' rel='noopener'>Weld Inspection Guide</a>. Learn more about <a href='https://ndt-connect.com/tools/ndt-method-selector' target='_blank' rel='noopener'>NDT Method Selector Tool</a>. Learn more about <a href='https://ndt-connect.com/blog/ndt-certifications-explained' target='_blank' rel='noopener'>NDT Certifications Explained</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding advanced ut techniques overview is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-for-castings' style={{ color: '#1e40af' }}>&larr; UT Inspection of Castings</a>
        <a href='/ut-transducer-guide' style={{ color: '#1e40af' }}>UT Transducer Selection Guide &rarr;</a>
      </div>
    </div>
  );
}
