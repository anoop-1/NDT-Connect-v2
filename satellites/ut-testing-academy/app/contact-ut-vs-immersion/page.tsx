...
export const metadata: Metadata = {
  title: 'Contact UT vs Immersion Testing',
  description: 'Comparing contact and immersion ultrasonic testing methods, their advantages, limitations, and best applications.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/contact-ut-vs-immersion' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Contact UT vs Immersion Testing</span>
      </nav>

      <h1>Contact UT vs Immersion Testing</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comparing contact and immersion ultrasonic testing methods, their advantages, limitations, and best applications.</p>
      ...
      <h2>Overview</h2>
      <p>Comparing contact and immersion ultrasonic testing methods, their advantages, limitations, and best applications. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/industries/aerospace' target='_blank' rel='noopener'>Aerospace NDT</a>. Learn more about <a href='https://ndt-connect.com/certifications/pcn-certification' target='_blank' rel='noopener'>PCN Certification</a>. Learn more about <a href='https://ndt-connect.com/services/radiographic-testing' target='_blank' rel='noopener'>Radiographic Testing Services</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding contact ut vs immersion testing is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-calibration-procedures' style={{ color: '#1e40af' }}>&larr; UT Calibration Procedures</a>
        <a href='/ut-for-composites' style={{ color: '#1e40af' }}>Ultrasonic Testing of Composites &rarr;</a>
      </div>
    </div>
  );
}
