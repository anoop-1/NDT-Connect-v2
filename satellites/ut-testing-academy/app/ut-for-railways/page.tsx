...
export const metadata: Metadata = {
  title: 'UT in Railway Inspection',
  description: 'Application of ultrasonic testing in railway rail and wheel inspection for safety-critical defect detection.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-for-railways' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>UT in Railway Inspection</span>
      </nav>

      <h1>UT in Railway Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Application of ultrasonic testing in railway rail and wheel inspection for safety-critical defect detection.</p>
      ...
      <h2>Overview</h2>
      <p>Application of ultrasonic testing in railway rail and wheel inspection for safety-critical defect detection. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/find-providers' target='_blank' rel='noopener'>Find NDT Providers</a>. Learn more about <a href='https://ndt-connect.com/tools/ndt-method-selector' target='_blank' rel='noopener'>NDT Method Selector Tool</a>. Learn more about <a href='https://ndt-connect.com/certifications/api-570' target='_blank' rel='noopener'>API 570 Certification</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding ut in railway inspection is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-for-bolts-fasteners' style={{ color: '#1e40af' }}>&larr; UT Inspection of Bolts and Fasteners</a>
        <a href='/ut-underwater-testing' style={{ color: '#1e40af' }}>Underwater Ultrasonic Testing &rarr;</a>
      </div>
    </div>
  );
}
