...
export const metadata: Metadata = {
  title: 'UT for Heat Exchanger Inspection',
  description: 'Ultrasonic testing methods for heat exchanger tube inspection including IRIS and conventional techniques.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-for-heat-exchangers' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>UT for Heat Exchanger Inspection</span>
      </nav>

      <h1>UT for Heat Exchanger Inspection</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Ultrasonic testing methods for heat exchanger tube inspection including IRIS and conventional techniques.</p>
      ...
      <h2>Overview</h2>
      <p>Ultrasonic testing methods for heat exchanger tube inspection including IRIS and conventional techniques. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/services/magnetic-flux-leakage' target='_blank' rel='noopener'>Magnetic Flux Leakage Testing</a>. Learn more about <a href='https://ndt-connect.com/industries/oil-and-gas' target='_blank' rel='noopener'>Oil & Gas NDT</a>. Learn more about <a href='https://ndt-connect.com/blog/ndt-career-guide-2026' target='_blank' rel='noopener'>NDT Career Guide</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding ut for heat exchanger inspection is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-training-paths' style={{ color: '#1e40af' }}>&larr; UT Training and Certification Paths</a>
        <a href='/ut-digital-recording' style={{ color: '#1e40af' }}>Digital UT and Data Management &rarr;</a>
      </div>
    </div>
  );
}
