...
export const metadata: Metadata = {
  title: 'Underwater Ultrasonic Testing',
  description: 'Methods and equipment for performing ultrasonic testing underwater for offshore structures and marine applications.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-underwater-testing' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Underwater Ultrasonic Testing</span>
      </nav>

      <h1>Underwater Ultrasonic Testing</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Methods and equipment for performing ultrasonic testing underwater for offshore structures and marine applications.</p>
      ...
      <h2>Overview</h2>
      <p>Methods and equipment for performing ultrasonic testing underwater for offshore structures and marine applications. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/industries/mining' target='_blank' rel='noopener'>Mining NDT</a>. Learn more about <a href='https://ndt-connect.com/services/acoustic-emission-testing' target='_blank' rel='noopener'>Acoustic Emission Testing</a>. Learn more about <a href='https://ndt-connect.com/blog/ultimate-guide-ultrasonic-testing' target='_blank' rel='noopener'>Ultrasonic Testing Guide</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding underwater ultrasonic testing is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-for-railways' style={{ color: '#1e40af' }}>&larr; UT in Railway Inspection</a>
        <a href='/ut-automated-scanning' style={{ color: '#1e40af' }}>Automated UT Scanning Systems &rarr;</a>
      </div>
    </div>
  );
}
