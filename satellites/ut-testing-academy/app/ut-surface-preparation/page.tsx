...
export const metadata: Metadata = {
  title: 'Surface Preparation for UT',
  description: 'Requirements and methods for surface preparation before ultrasonic testing to ensure reliable results.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-surface-preparation' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Surface Preparation for UT</span>
      </nav>

      <h1>Surface Preparation for UT</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Requirements and methods for surface preparation before ultrasonic testing to ensure reliable results.</p>
      ...
      <h2>Overview</h2>
      <p>Requirements and methods for surface preparation before ultrasonic testing to ensure reliable results. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com' target='_blank' rel='noopener'>NDT Connect</a>. Learn more about <a href='https://ndt-connect.com/certifications/pcn-certification' target='_blank' rel='noopener'>PCN Certification</a>. Learn more about <a href='https://ndt-connect.com/services/radiographic-testing' target='_blank' rel='noopener'>Radiographic Testing Services</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding surface preparation for ut is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-for-pressure-vessels' style={{ color: '#1e40af' }}>&larr; UT for Pressure Vessel Inspection</a>
        <a href='/ut-limitations-artifacts' style={{ color: '#1e40af' }}>UT Limitations and Artifacts &rarr;</a>
      </div>
    </div>
  );
}
