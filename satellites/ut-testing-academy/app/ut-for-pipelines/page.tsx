...
export const metadata: Metadata = {
  title: 'UT Pipeline Inspection Methods',
  description: 'Ultrasonic testing methods for pipeline integrity assessment including girth weld inspection and wall thickness surveys.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-for-pipelines' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>UT Pipeline Inspection Methods</span>
      </nav>

      <h1>UT Pipeline Inspection Methods</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Ultrasonic testing methods for pipeline integrity assessment including girth weld inspection and wall thickness surveys.</p>
      ...
      <h2>Overview</h2>
      <p>Ultrasonic testing methods for pipeline integrity assessment including girth weld inspection and wall thickness surveys. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog/ultimate-guide-ultrasonic-testing' target='_blank' rel='noopener'>Ultrasonic Testing Guide</a>. Learn more about <a href='https://ndt-connect.com/tools/inspection-cost-estimator' target='_blank' rel='noopener'>NDT Cost Estimator</a>. Learn more about <a href='https://ndt-connect.com/industries/power-generation' target='_blank' rel='noopener'>Power Generation NDT</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding ut pipeline inspection methods is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-for-corrosion' style={{ color: '#1e40af' }}>&larr; UT Corrosion Detection Methods</a>
        <a href='/ut-signal-interpretation' style={{ color: '#1e40af' }}>UT Signal Interpretation Guide &rarr;</a>
      </div>
    </div>
  );
}
