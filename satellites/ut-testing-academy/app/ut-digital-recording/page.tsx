...
export const metadata: Metadata = {
  title: 'Digital UT and Data Management',
  description: 'Modern digital ultrasonic testing systems, data storage, cloud management, and AI-assisted analysis.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-digital-recording' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Digital UT and Data Management</span>
      </nav>

      <h1>Digital UT and Data Management</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Modern digital ultrasonic testing systems, data storage, cloud management, and AI-assisted analysis.</p>
      ...
      <h2>Overview</h2>
      <p>Modern digital ultrasonic testing systems, data storage, cloud management, and AI-assisted analysis. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog/ut-vs-rt-comparison' target='_blank' rel='noopener'>UT vs RT Comparison</a>. Learn more about <a href='https://ndt-connect.com/certifications/iso-9712' target='_blank' rel='noopener'>ISO 9712 Certification</a>. Learn more about <a href='https://ndt-connect.com/find-providers' target='_blank' rel='noopener'>Find NDT Providers</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding digital ut and data management is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-for-heat-exchangers' style={{ color: '#1e40af' }}>&larr; UT for Heat Exchanger Inspection</a>
        <a href='/ut-probability-detection' style={{ color: '#1e40af' }}>UT Probability of Detection &rarr;</a>
      </div>
    </div>
  );
}
