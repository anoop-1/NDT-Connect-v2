...
export const metadata: Metadata = {
  title: 'Guided Wave UT Explained',
  description: 'Principles and applications of guided wave ultrasonic testing for long-range pipeline and structural inspection.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-guided-waves' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Guided Wave UT Explained</span>
      </nav>

      <h1>Guided Wave UT Explained</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Principles and applications of guided wave ultrasonic testing for long-range pipeline and structural inspection.</p>
      ...
      <h2>Overview</h2>
      <p>Principles and applications of guided wave ultrasonic testing for long-range pipeline and structural inspection. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog/corrosion-under-insulation-guide' target='_blank' rel='noopener'>CUI Guide</a>. Learn more about <a href='https://ndt-connect.com/blog/ndt-industry-statistics' target='_blank' rel='noopener'>NDT Industry Statistics</a>. Learn more about <a href='https://ndt-connect.com/tools/ndt-method-selector' target='_blank' rel='noopener'>NDT Method Selector Tool</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding guided wave ut explained is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-for-aerospace' style={{ color: '#1e40af' }}>&larr; UT in Aerospace Applications</a>
        <a href='/ut-for-storage-tanks' style={{ color: '#1e40af' }}>UT for Storage Tank Inspection &rarr;</a>
      </div>
    </div>
  );
}
