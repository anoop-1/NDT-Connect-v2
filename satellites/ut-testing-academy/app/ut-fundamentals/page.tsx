...
export const metadata: Metadata = {
  ...
  description: 'Understanding the basic principles of ultrasonic testing including sound wave propagation, transducer types, and signal interpretation for industrial inspection applications.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-fundamentals' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Ultrasonic Testing Fundamentals</span>
      </nav>

      <h1>Ultrasonic Testing Fundamentals</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Understanding the basic principles of ultrasonic testing including sound wave propagation, transducer types, and signal interpretation for industrial inspection applications.</p>
      ...
      <h2>Overview</h2>
      <p>Understanding the basic principles of ultrasonic testing including sound wave propagation, transducer types, and signal interpretation for industrial inspection applications. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/blog/pipeline-inspection-techniques' target='_blank' rel='noopener'>Pipeline Inspection</a>. Learn more about <a href='https://ndt-connect.com/blog' target='_blank' rel='noopener'>NDT Blog</a>. Learn more about <a href='https://ndt-connect.com/certifications/asnt-certification' target='_blank' rel='noopener'>ASNT Certification</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding ultrasonic testing fundamentals is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <span></span>
        <a href='/ut-equipment-guide' style={{ color: '#1e40af' }}>UT Equipment Selection Guide &rarr;</a>
      </div>
    </div>
  );
}
