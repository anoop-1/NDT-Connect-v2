...
export const metadata: Metadata = {
  title: 'UT Training and Certification Paths',
  description: 'Career development guide for ultrasonic testing professionals including training programs and certification options.',
  alternates: { canonical: 'https://ut-testing-academy.vercel.app/ut-training-paths' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>UT Training and Certification Paths</span>
      </nav>

      <h1>UT Training and Certification Paths</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Career development guide for ultrasonic testing professionals including training programs and certification options.</p>
      ...
      <h2>Overview</h2>
      <p>Career development guide for ultrasonic testing professionals including training programs and certification options. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndt-connect.com/certifications/api-653' target='_blank' rel='noopener'>API 653 Certification</a>. Learn more about <a href='https://ndt-connect.com/services/visual-testing' target='_blank' rel='noopener'>Visual Testing Services</a>. Learn more about <a href='https://ndt-connect.com/services/corrosion-mapping' target='_blank' rel='noopener'>Corrosion Mapping Services</a>.</p>

      <h2>Key Considerations</h2>
      <p>Understanding ut training and certification paths is essential for maintaining asset integrity and ensuring safety compliance. Professional NDT inspectors rely on established codes, standards, and best practices to deliver reliable results. Whether you are performing inspections in <a href='https://ndt-connect.com/ndt-services/houston' target='_blank' rel='noopener'>Houston</a>, <a href='https://ndt-connect.com/ndt-services/aberdeen' target='_blank' rel='noopener'>Aberdeen</a>, or <a href='https://ndt-connect.com/ndt-services/singapore' target='_blank' rel='noopener'>Singapore</a>, the fundamental principles remain consistent.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/ut-tofd-introduction' style={{ color: '#1e40af' }}>&larr; Introduction to TOFD Testing</a>
        <a href='/ut-for-heat-exchangers' style={{ color: '#1e40af' }}>UT for Heat Exchanger Inspection &rarr;</a>
      </div>
    </div>
  );
}
