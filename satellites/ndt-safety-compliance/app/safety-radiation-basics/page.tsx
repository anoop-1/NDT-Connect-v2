...
export const metadata: Metadata = {
  title: 'Radiation Safety Basics',
  description: 'Comprehensive guide to radiation safety basics for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-safety-compliance.vercel.app/safety-radiation-basics' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Radiation Safety Basics</span>
      </nav>

      <h1>Radiation Safety Basics</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to radiation safety basics for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/safety-overview' style={{ color: '#ea580c' }}>&larr; NDT Safety Fundamentals</a>
        <a href='/safety-alara-principles' style={{ color: '#ea580c' }}>ALARA Principles in RT &rarr;</a>
      </div>
    </div>
  );
}
