...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive guide to building safety culture for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-safety-compliance.vercel.app/safety-safety-culture' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Building Safety Culture</span>
      </nav>

      <h1>Building Safety Culture</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to building safety culture for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/safety-training-safety' style={{ color: '#ea580c' }}>&larr; NDT Safety Training</a>
        <span></span>
      </div>
    </div>
  );
