...
export const metadata: Metadata = {
  title: 'NDT Safety Fundamentals',
  description: 'Comprehensive guide to ndt safety fundamentals for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-safety-compliance.vercel.app/safety-overview' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>NDT Safety Fundamentals</span>
      </nav>

      <h1>NDT Safety Fundamentals</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to ndt safety fundamentals for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <span></span>
        <a href='/safety-radiation-basics' style={{ color: '#ea580c' }}>Radiation Safety Basics &rarr;</a>
      </div>
    </div>
  );
}
