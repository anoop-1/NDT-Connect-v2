...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive guide to osha requirements for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-safety-compliance.vercel.app/safety-osha-requirements' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>OSHA Requirements</span>
      </nav>

      <h1>OSHA Requirements</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to osha requirements for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/safety-audit-preparation' style={{ color: '#ea580c' }}>&larr; NDT Audit Preparation</a>
        <a href='/safety-nrc-regulations' style={{ color: '#ea580c' }}>NRC Regulations &rarr;</a>
      </div>
    </div>
  );
}
