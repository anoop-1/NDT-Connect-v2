...
export const metadata: Metadata = {
  title: 'Ergonomics in NDT',
  description: 'Comprehensive guide to ergonomics in ndt for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-safety-compliance.vercel.app/safety-ergonomics' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Ergonomics in NDT</span>
      </nav>

      <h1>Ergonomics in NDT</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to ergonomics in ndt for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/safety-incident-reporting' style={{ color: '#ea580c' }}>&larr; NDT Incident Reporting</a>
        <a href='/safety-heat-stress' style={{ color: '#ea580c' }}>Heat Stress in NDT &rarr;</a>
      </div>
    </div>
  );
}
