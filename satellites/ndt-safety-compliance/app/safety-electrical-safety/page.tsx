...
export default function Page() {
  return (
    <div>
      ...
      <h2>Overview</h2>
      <p>Comprehensive guide to electrical safety in ndt for NDT professionals in industrial inspection and asset integrity management. This is a critical area of knowledge for NDT professionals working across industries including oil and gas, aerospace, power generation, and manufacturing. Learn more about <a href='https://ndtconnect.com/tools/certification-pathway' target='_blank' rel='noopener'>Certification Pathway Planner</a>. Learn more about <a href='https://ndtconnect.com/blog/rbi-corrosion-management' target='_blank' rel='noopener'>RBI Corrosion Management</a>. Learn more about <a href='https://ndtconnect.com/contact' target='_blank' rel='noopener'>Contact NDT Connect</a>.</p>
