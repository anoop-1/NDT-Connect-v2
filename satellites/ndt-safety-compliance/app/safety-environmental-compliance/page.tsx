...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive guide to environmental compliance for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-safety-compliance.vercel.app/safety-environmental-compliance' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Environmental Compliance</span>
      </nav>

      <h1>Environmental Compliance</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to environmental compliance for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/safety-risk-assessment' style={{ color: '#ea580c' }}>&larr; Risk Assessment for NDT</a>
        <a href='/safety-lifting-equipment' style={{ color: '#ea580c' }}>Lifting Equipment Safety &rarr;</a>
      </div>
    </div>
  );
}
