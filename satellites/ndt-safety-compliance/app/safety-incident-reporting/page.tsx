...
export const metadata: Metadata = {
  title: 'NDT Incident Reporting',
  description: 'Comprehensive guide to ndt incident reporting for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-safety-compliance.vercel.app/safety-incident-reporting' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>NDT Incident Reporting</span>
      </nav>

      <h1>NDT Incident Reporting</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to ndt incident reporting for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/safety-international-regulations' style={{ color: '#ea580c' }}>&larr; International RT Regulations</a>
        <a href='/safety-ergonomics' style={{ color: '#ea580c' }}>Ergonomics in NDT &rarr;</a>
      </div>
    </div>
  );
}
