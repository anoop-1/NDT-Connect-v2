...
export const metadata: Metadata = {
  title: 'Cold Weather NDT',
  description: 'Comprehensive guide to cold weather ndt for NDT professionals in industrial inspection and asset integrity management.',
  alternates: { canonical: 'https://ndt-safety-compliance.vercel.app/safety-cold-weather' },
};
  ...
  return (
    <div>
      <nav style={{ fontSize: '0.85rem', color: '#888', marginBottom: '24px' }}>
        <a href='/' style={{ color: '#888' }}>Home</a> / <span>Cold Weather NDT</span>
      </nav>

      <h1>Cold Weather NDT</h1>
      <p style={{ fontSize: '1.05rem', color: '#666' }}>Comprehensive guide to cold weather ndt for NDT professionals in industrial inspection and asset integrity management.</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '16px', borderTop: '1px solid #e5e7eb', fontSize: '0.9rem' }}>
        <a href='/safety-heat-stress' style={{ color: '#ea580c' }}>&larr; Heat Stress in NDT</a>
        <a href='/safety-ppe-requirements' style={{ color: '#ea580c' }}>PPE Requirements &rarr;</a>
      </div>
    </div>
  );
}
