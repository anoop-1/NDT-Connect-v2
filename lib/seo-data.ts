...
export const certifications: CertificationData[] = [
  {
    ...
    levels: ['Level I - Performs specific calibrations, tests, and evaluations to written instructions under the supervision of Level II or III personnel, and records results.', 'Level II - Sets up and calibrates equipment, interprets and evaluates results against codes and specifications, prepares written instructions, and supervises Level I trainees. Most working field inspectors hold Level II in one or more methods.', 'Level III - Establishes and approves techniques and procedures, interprets codes, standards and specifications, administers examinations, and certifies Level I and II personnel. The highest individual qualification.'],
    requirements: ['Documented classroom training hours per method and level (e.g. UT Level II commonly requires about 80 hours; specifics vary by method and by SNT-TC-1A vs CP-189)', 'Minimum on-the-job experience hours accrued per method and level', 'Basic exam plus method-specific written examination (general + specific), and a practical examination for Levels I and II', 'Minimum 70% on each exam section, with an 80% composite required for Level III', 'Annual near-vision (Jaeger J-1/J-2) and color-contrast vision verification', 'SNT-TC-1A: employer written-practice authorization. CP-189: prescribed national minimums. ACCP / NDT Level III: third-party ASNT examination producing a portable credential.'],
    examTopics: ['Principles and physics of each NDT method', 'Equipment setup, calibration, and reference-standard use', 'SNT-TC-1A, ANSI/ASNT CP-189, and applicable code and standard interpretation', 'Discontinuity detection, characterization, and acceptance-criteria evaluation', 'Materials, fabrication, and product technology (Basic exam)', 'Procedure and written-instruction preparation', 'Reporting, documentation, and radiation/equipment safety'],
  ...
  },
  {
    ...
    levels: ['Single level - API 570 Authorized Piping Inspector, certified to apply the full API 570 Piping Inspection Code to in-service systems.'],
    ...
    examTopics: ['API 570 Piping Inspection Code requirements', 'ASME B31.3 Process Piping design and allowable-stress basics', 'Corrosion-monitoring locations (CMLs) and thickness-survey strategy', 'Corrosion-rate, remaining-life, and minimum-required-thickness calculations', 'Piping damage mechanisms per API 571', 'Welding and NDE for piping repairs (API 577, ASME Section V)', 'Repair, alteration, rerating, and temporary-repair rules'],
    validityPeriod: '3 years',
    issuingBody: 'American Petroleum Institute',
  ...
  },
  {
    ...
    levels: ['Single level - API 653 Authorized Tank Inspector, certified to apply the full API 653 code to in-service aboveground storage tanks.'],
