...
const TIER_1_CITIES: City[] = [
  ...
  },
  {
    ...
    industries: ["Permian shale upstream", "Midstream pipelines"],
  ...
  },
  {
    ...
    region: "permian-basin", tier: 1,
    industries: ["Permian shale upstream", "Equipment yards"],
  ...
  },
  {
    ...
    region: "gulf-coast", tier: 1,
    industries: ["LNG export", "Petrochemical"],
  ...
  },
  {
    ...
    region: "mountain-west", tier: 1,
    industries: ["Oil and gas upstream", "Refining"],
    codeAuthorities: ["API 510 / 570", "PHMSA"],
    namedFacilities: [
      { name: "Sinclair Casper Refinery", type: "Refinery" },
    ],
    localPainQuote: "Wyoming winters extend equipment turnaround for repair and recalibration — the planning lead time on a single phased-array unit can run 60 days.",
  },
  {
  ...
  },
  {
    ...
    region: "pacific-northwest", tier: 1,
    industries: ["Aerospace (Boeing 787, 777, 747)", "Composites inspection"],
  ...
  // ---------------- TIER 1 — Southwest ----------------
  {
    ...
    industries: ["Aerospace", "Semiconductor manufacturing"],
  ...
  },
  {
    ...
    namedFacilities: [
      { name: "Raytheon Tucson", type: "Defense" },
    ],
    localPainQuote: "Defense primes apply DCMA-style audit standards to NDT subcontractors — an expired ASNT cert on file is treated as a non-conformance.",
  },
  // ---------------- TIER 1 — Texas Triangle (non-Houston) ----------------
  {
    ...
    industries: ["Manufacturing", "Aerospace HQs", "Telecom"],
    codeAuthorities: ["FAA Part 145", "ASME"],
    namedFacilities: [
      { name: "Bell Textron Hurst (regional)", type: "Aerospace" },
    ],
  ...
  },
  {
    ...
    region: "texas-triangle", tier: 1,
    industries: ["Aerospace (Lockheed F-35, Bell)", "Manufacturing"],
    codeAuthorities: ["FAA Part 145", "NAS 410", "DCMA"],
    namedFacilities: [
  ...
  // ---------------- TIER 1 — Northeast ----------------
  {
    ...
    industries: ["Refining (legacy + biofuels)", "Pharma manufacturing"],
    codeAuthorities: ["API 510 / 570", "FDA cGMP"],
    namedFacilities: [
      { name: "Monroe Energy Trainer Refinery (regional)", type: "Refinery" },
    ],
    localPainQuote: "Northeast refinery contractors juggle API and pharma-cGMP compliance frameworks — neither permits expired-cert technicians on site.",
  },
  {
    slug: "newark-nj",
  ...
  },
  {
    ...
    region: "northeast", tier: 1,
    industries: ["Aerospace (Pratt & Whitney)", "Defense"],
    codeAuthorities: ["FAA Part 145", "NAS 410"],
    namedFacilities: [
  ...
  // ---------------- TIER 1 — Southeast ----------------
  {
    ...
    industries: ["Power generation (Duke Energy)", "Aerospace", "Heavy manufacturing"],
    codeAuthorities: ["NERC", "ASME Section XI for nuclear", "NRC"],
    namedFacilities: [
      { name: "Duke Energy Charlotte HQ", type: "Power generation" },
    ],
  ...
  },
  {
    ...
    region: "southeast", tier: 1,
    industries: ["Aerospace (Gulfstream)", "Port operations"],
    codeAuthorities: ["FAA Part 145", "NAS 410", "USCG"],
    namedFacilities: [
      { name: "Gulfstream Aerospace Savannah", type: "Aerospace" },
      { name: "Port of Savannah", type: "Port" },
    ],
    localPainQuote: "Gulfstream business-jet inspections require FAA-traceable cert and cal records on every shift — the cost of an audit miss is the contract.",
  },
  {
  ...
  // ---------------- TIER 1 — Mid-South ----------------
  {
    ...
    region: "midwest", tier: 1,
    industries: ["Aerospace (Spirit, Textron, Bombardier)"],
    codeAuthorities: ["FAA Part 145", "NAS 410"],
    namedFacilities: [
      { name: "Spirit AeroSystems Wichita", type: "Aerospace" },
      { name: "Textron Aviation (Cessna)", type: "Aerospace" },
    ],
  ...
  // ---------------- TIER 1 — Nuclear corridor ----------------
  {
    ...
    region: "southeast", tier: 1,
    industries: ["Nuclear", "DOE research"],
  ...
  },
  {
    ...
    region: "southeast", tier: 1,
    industries: ["Nuclear services", "Heavy manufacturing"],
    codeAuthorities: ["10 CFR 50", "ASME Section XI", "NRC"],
    namedFacilities: [
      { name: "Westinghouse Newington (regional)", type: "Nuclear services" },
    ],
    localPainQuote: "Greenville nuclear-services contractors mobilise to multiple utility outages per year — cert and cal traceability has to follow the technician, not the home base.",
  },
  {
    slug: "aiken-sc",
    name: "Aiken", state: "SC", country: "US",
    region: "southeast", tier: 1,
    industries: ["Nuclear", "DOE Savannah River"],
    codeAuthorities: ["10 CFR 50", "ASME Section XI", "NRC", "DOE-STD"],
    namedFacilities: [
      { name: "Savannah River Site", type: "DOE nuclear" },
    ],
    localPainQuote: "DOE Savannah River audit standards exceed commercial NRC standards — every instrument cal record is subpoena-grade.",
  },
  {
    slug: "richland-wa",
    name: "Richland (Tri-Cities)", state: "WA", country: "US",
    region: "pacific-northwest", tier: 1,
    industries: ["Nuclear", "DOE Hanford"],
  ...
  // ---------------- TIER 1 — Frontier US ----------------
  {
    ...
    industries: ["Pipelines (Trans-Alaska)", "Oil and gas upstream"],
  ...
  },
  {
    ...
    region: "frontier-us", tier: 1,
    industries: ["US Navy", "Port operations"],
    codeAuthorities: ["NAVSEA", "USCG"],
    namedFacilities: [
      { name: "Pearl Harbor Naval Shipyard", type: "Navy" },
    ],
    localPainQuote: "Pacific-fleet ship-repair work demands SUBSAFE-grade NDT records — every cert and cal entry is auditable indefinitely.",
  },
  {
    slug: "billings-mt",
  ...
  },
  {
    ...
    region: "midwest", tier: 1,
    industries: ["Bakken oil and gas support", "Agriculture infrastructure"],
    codeAuthorities: ["API 570", "PHMSA"],
    namedFacilities: [
      { name: "Bakken support yards (regional)", type: "Oilfield services" },
    ],
    localPainQuote: "Bakken-support NDT crews mobilise across three states from Fargo — equipment chain-of-custody breaks down without a single live registry.",
  },
];
