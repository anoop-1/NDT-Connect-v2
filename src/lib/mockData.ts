...
export const MOCK_PROVIDERS: ServiceProvider[] = [
  {
    ...
    services: MOCK_DEMO_PROVIDER.providerProfile!.servicesOffered!,
    specialization: MOCK_DEMO_PROVIDER.providerProfile!.specialization!,
    rating: MOCK_DEMO_PROVIDER.providerProfile!.rating!,
    description: MOCK_DEMO_PROVIDER.providerProfile!.description,
    imageUrl: MOCK_DEMO_PROVIDER.providerProfile!.companyLogoUrl,
    dataAiHint: MOCK_DEMO_PROVIDER.providerProfile!.dataAiHint,
